...
//					grade = ("".equals(actual) ? "0" : grade);
			...
			if ("R".equals(tag)){                                                                     
				...
				if ("2007".equals(year)) { //||"12".equals(month)){
						// GROUP에 해당되는 지표삭제  : 지표의 주기에 따라 기간설정필요...                                  
	         ...
	         if ("2007".equals(year)) {
	        	 ...
	        	 /*
					...
					if ("12".equals(month)){
				         ...
				         strSQL.append("         mea.measureid, CASE WHEN (mea.MEASCHAR='I') THEN '고유' ELSE '공통' END mkind, measchar ,                                  \n");
				         ...
				         strSQL.append("         and    d.measurement = '비계량'                                                                                            \n");
				         strSQL.append("        ) mea,                                                                                                                      \n");
				         strSQL.append("        (                                                                                                                           \n");
