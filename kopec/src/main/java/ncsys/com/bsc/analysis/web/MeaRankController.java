...
@Controller
@RequestMapping("/analysis/meaRank")
public class MeaRankController {

	@Resource(name = "orgScoreService")
	private OrgScoreService orgScoreService;

	@Resource(name="meaRankService")
	private  MeaRankService meaRankService;


	@RequestMapping(value = "/meaRank.do")
	public String view(Model model) throws Exception {
		...
		return "ncsys/bsc/analysis/meaRank/meaRank.tiles";
	}




	@RequestMapping(value = "/selectMeasureYear.json", method = RequestMethod.POST)
	public ModelAndView selectMeasureYear(@RequestParam HashMap<String, Object> param) {
		ModelAndView mv = new ModelAndView("jsonView");
		try {
			List<Map<String, Object>> meaList = meaRankService.selectMeasureYear(param);
			mv.addObject("meaList", meaList);
	...
	@RequestMapping(value = "/selectMeaRank.json", method = RequestMethod.POST)
	public ModelAndView selectMeaRank(@RequestParam HashMap<String, Object> param) {
		ModelAndView mv = new ModelAndView("jsonView");
		try {
			List<Map<String, Object>> meaRank = meaRankService.selectMeaRank(param);
			mv.addObject("meaRank", meaRank);
