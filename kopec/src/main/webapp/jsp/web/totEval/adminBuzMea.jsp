...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  id="tblList">
	<tr>
		<td width="50%">
			<iframe frameborder="0" id="list" src="adminBuzMeaList.jsp" style="body" width="100%" height="350">&nbsp;</iframe>
		</td>
		<td>&nbsp;</td>
		<td width="48%">
			<iframe frameborder="0" id="detail" style="display:inline" src="adminBuzMeaDetail.jsp" style="body" width="100%" height="350">&nbsp;</iframe>
		</td>		
	</tr>
</table>
<!---------///본문 컨텐츠 삽입영역  끝///--------->
