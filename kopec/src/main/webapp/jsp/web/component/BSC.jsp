...
<script type="text/javascript">
	...
	function fnSearch(mode){
		...
		if (mode=='Q') {
			...
			$("#frameDetail").contents().find("input[name=kind]").val('bsc');
	...
	<table width = "100%" height="4.4%" border = "0" align = "center" cellpadding = "0" cellspacing = "0">
		<tr>
        	<td height="30"><img src="<%=imgUri%>/images/icon_point_01.gif" width="8" height="9" align="absmiddle">
            	<strong>조직명 :</strong> <input name="txtSearch" type="text" class="input_box" size="40" onKeypress="javascript: if (event.keyCode =='13') fnSearch('Q');">
      ...
      <table width="100%" height="95.6%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td>
            <!--iframe 시작-->
            <iframe id="frameDetail" frameborder="0" src="BSCDetail.jsp" width="100%" height="100%" scrolling="no">&nbsp;</iframe>
            <!--iframe 끝-->
          </td>
        </tr>
      </table>
