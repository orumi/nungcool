...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="190" height="44" background="images/box_top_bg.gif"><img src="images/title_img_03.gif" width="190" height="44"></td>
  ...
  <tr> 
	...
	<!---------///본문 컨텐츠 삽입영역 ///--------->
	<iframe frameborder="0" src="report/report.jsp" style="body" width="100%" height="100%" >&nbsp;</iframe>
	<!---------///본문 컨텐츠 삽입영역  끝///--------->
	</td>
