...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#A4CBE3">
              ...
              <tr align="center" bgcolor="#D4DCF4"> 
                ...
                <td><strong><font color="#003399">순위</font></strong></td>
              </tr>
              <tr bgcolor="#FFFFFF"> 
            ...
            <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                <td height="30" align="right"><a href="#"><img src="<%=imgUri %>/jsp/web/images/btn_save.gif" alt="저장" width="50" height="20" border="0" align="absmiddle"></a> 
                  &nbsp; <a href="#"><img src="<%=imgUri %>/jsp/web/images/btn_reset.gif" alt="초기화" width="65" height="20" border="0" align="absmiddle"></a></td>
              </tr>
            </table>  </form>
</body>
</html>