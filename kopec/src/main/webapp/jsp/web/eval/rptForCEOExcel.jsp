...
<table width="650" border="1" cellpadding="5" cellspacing="0" bgcolor="#9DB5D7">
	...
	<tr bgcolor="#FFFFFF">
		...
		<td width="298" align="center" bgcolor="#D4DCF4" rowspan="2"><font color="#003399"><strong>조직명</strong></font></td>
		<td width="30" align="center" bgcolor="#D4DCF4" rowspan="2"><font color="#003399"><strong>상태</strong></font></td>
		<td width="60" align="center" bgcolor="#D4DCF4" rowspan="2"><font color="#003399"><strong>종합성과</strong></font></td>
...
<% if(dsBsc != null){
	...
	<tr bgcolor="#FFFFFF">
		<td colspan="11" height="25" bgcolor="#9DB5D7"><strong> 내부분석의견</strong></td>
	</tr>
<% if(dsMea != null){
		int tmpbcid = 0;
   		while (dsMea.next()) {
