...
<%
	...
	String strdate = request.getParameter("strDate")!=null?request.getParameter("strDate"):"200712";//Util.getSemi(Util.getToDay().substring(0,6));
...
<script>
	...
	function sendItem(){
		if (-1 == form1.selDiv.selectedIndex){
			alert('해당 평가대상조직을 선택하셔야 됩니다.');
			return;
		} else {
			var isDiv = false;
			for (var j=0; j < form1.selGroupDetail.length; j++) {
				if (form1.selDiv.options[form1.selDiv.selectedIndex].value == form1.selGroupDetail.options[j].value) {
					isDiv = true;
					if (isDiv == true) {
						alert("이미 평가대상조직에 있습니다.");
						return;
					}
				}
			}
...
%>
	...
	<input type="hidden" name="tag" value="2007">
      ...
      <table width="100" border="0" align="left" cellpadding="5" cellspacing="1">
        <tr> 
		  ...
		  <table width="200" border="0" cellpadding="5" cellspacing="1" bgcolor="#9DB5D7">
              <tr>
                <td align="center" bgcolor="#D4DCF4"><font color="#003399"><strong>조직목록</strong></font></td>
              </tr>
              <tr>
		  ...
		  <table width="210" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
              <tr> 
                <td align="center" bgcolor="#E0E0E0"><font color="#000000"><strong>평가대상그룹</strong></font></td>
              </tr>
              <tr>
                <td bgcolor="#FFFFFF">
        ...
        <tr> 
		  ...
		  <table width="210" border="0" cellpadding="5" cellspacing="1" bgcolor="#9DB5D7">
              <tr> 
                <td align="center" bgcolor="#D4DCF4"><font color="#003399"><strong>평가대상조직</strong></font></td>
              </tr>
              <tr> 
                <td align="center" bgcolor="#FFFFFF">
