...
<%
	...
	String year = request.getParameter("year")!=null?request.getParameter("year"):"2007";//Util.getToDay().substring(0,4);
	...
	<%} else {
		...
		util.setEvalGroup2007_1(request, response);
		String month = "12";//request.getParameter("month")!=null?request.getParameter("month"):(String)request.getAttribute("month");
		...
		<td width="86%" bgcolor="#FFFFFF">
			<select name="year" onChange="javascript:changeYear();">
             ...
             <select name="month" onChange="javascript:getEvalDiv();";>
	             <option value="12" selected>4/4분기</option>
             </select>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  id="tblList">
	<tr>
		<td>
			<iframe frameborder="0" scrolling="no" id="list" src="doValuateList2007_1.jsp" style="body" width="100%" height="550">&nbsp;</iframe>
		</td>
	</tr>
</table>
<!---------///본문 컨텐츠 삽입영역  끝///--------->
