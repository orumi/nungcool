...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr valign="top">
		<td width="100%" height="220">
			<iframe frameborder="0" id="list" src="valuateActList.jsp?mode=none" style="body" width="100%" height="220">&nbsp;</iframe>
		</td>
	</tr>
	<tr>
		<td width="100%" height="250">
			<iframe frameborder="0" id="detail" style="display:inline" src="valuateActDetail.jsp?mode=none" style="body" width="100%" height="250">&nbsp;</iframe>
		</td>
	</tr>
</table>
<!---------///본문 컨텐츠 삽입영역  끝///--------->
