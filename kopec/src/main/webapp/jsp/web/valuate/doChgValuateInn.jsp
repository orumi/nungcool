...
<%
	...
	<%} else {
		...
		util.setEvalInn(request, response);
		
		
		DataSet dsGrp = (DataSet) request.getAttribute("ds");
%>
<SCRIPT>
	var initCon = false;
    function actionPerformed(){
    	
    	if (form1.firstPart.length==0) {
    		alert("평가 그룹을 선택해 주십시오");
    		return;
    	}
    	var frm = list.form1;
...
<table width="98%" border="0" align="center" cellpadding="5"
	...
	<tr bgcolor="#DCEDF6">
		...
		<td bgcolor="#FFFFFF">
		<select name="firstPart"  style="width:170;x;" onChange="javascript:changeYear();">
        	<%=grpBuf.toString()%>
        </select>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  id="tblList">
	<tr>
		<td >
			<iframe frameborder="0" id="list" src="doValuateInnList.jsp" style="body" width="100%" height="550">&nbsp;</iframe>
		</td>
	</tr>
</table>
<!---------///본문 컨텐츠 삽입영역  끝///--------->
