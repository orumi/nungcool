...
function openFrame(tag, obj1, obj2, obj3, obj4){
	...
	if (tag == 'com'){		
		adminContent.location.href="doValuateOrg.jsp";					
	} else if (tag == 'inn'){		
		adminContent.location.href="doValuateOrgInn.jsp";						
	} else if (tag == 'opn') {
		adminContent.location.href="doValuateOrgOpn.jsp";
	}
        ...
        <tr> 
          <td colspan="2" valign="top" bgcolor="#FFFFFF"> 
            ...
            <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>
		        <iframe frameborder="0" id="adminContent" src="doValuateOrg.jsp" style="body" width="100%" height="100%" scrolling="no">&nbsp;</iframe>
            </td></tr>
            </table>
          </td>
        </tr>
