...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  id="tblList">
	<tr>
		<td width="50%" valign="top">
			<iframe frameborder="0" id="list" src="doValuateOpnList.jsp" style="body" width="100%" height="300">&nbsp;</iframe>
		</td>
		<td>&nbsp;</td>
		<td width="48%" valign="top">			
			<iframe frameborder="0" id="detail01" src="doValuateOpnDetail01.jsp" style="body" width="100%" height="300">&nbsp;</iframe>
			<iframe frameborder="0" id="detail02" src="doValuateOpnDetail02.jsp" style="body" width="0" height="300">&nbsp;</iframe>
		</td>		
	</tr>
</table>
<!---------///본문 컨텐츠 삽입영역  끝///--------->
