...
<%
	...
	DataSet prtDetail_1 = (DataSet)request.getAttribute("prjDetail");
%>
            ...
            <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30"><strong><img src="<%=imgUri %>/jsp/web/images/icon_point_00.gif" width="15" height="15" align="absmiddle">
                  1단계 추진업무(세부실행과제 및 목표수준)</strong></td>
              </tr>
            </table>
...
<%
            if(prtDetail_1 != null)
            {
    			while(prtDetail_1.next())
    			{
%>
              <tr bgcolor="#FFFFFF">
                <td><a href="javascript:frmSend('<%=prtDetail_1.getString("detailid")%>','1')"><%=prtDetail_1.getString("execwork") %></a></td>
                <td align="center"><%=prtDetail_1.getString("drvperi") %></td>
                <td><%=prtDetail_1.getString("goallev") %></td>
                <td align="center"><%=prtDetail_1.getString("mgrdept") %></td>
              </tr>
<%
            }
			    }
