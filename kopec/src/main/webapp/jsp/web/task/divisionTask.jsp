...
<SCRIPT>
    ...
    function actionPerformed(){
		...
		frm.schDate.value = form1.year.options[form1.year.selectedIndex].value+form1.month.options[form1.month.selectedIndex].value;
		frm.submit();
    }
...
<table width="98%" border="0" align="center" cellpadding="5"
	...
	<tr bgcolor="#DCEDF6">
		...
		<td bgcolor="#FFFFFF"> 
		<select name="firstPart"  style="width:170;x;" onChange="javascript:chgOrg(1);">
        	<%=sbuBuf.toString()%>
        </select>
        <select name="secondPart" style="width:170;x;" onChange="javascript:changeBSC()">
        	<%=bscBuf.toString()%>
        </select> <img src="<%=imgUri%>/jsp/web/images/btn_ok.gif"
			alt="확인" onClick="javascript:actionPerformed();" style="cursor:hand" width="50" height="20" border="0" align="absmiddle"></td>
	</tr>
	</form>
</table>
<!------//상단 검색 끝//----->
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr valign="top">
		<td width="100%">
			<iframe frameborder="0" id="list" src="divisionTaskDetail.jsp" style="body" width="100%" height="440">&nbsp;</iframe>
		</td>
	</tr>
</table>
<!---------///본문 컨텐츠 삽입영역  끝///--------->
