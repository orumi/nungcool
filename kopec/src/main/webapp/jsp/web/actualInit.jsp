...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="190" height="44" background="images/box_top_bg.gif"><img src="images/title_img_06.gif" width="190" height="44"></td>
  ...
  <tr> 
	...
	<!---------///  ///--------->
	<iframe frameborder="0" src="actual/actual.jsp" style="body" width="100%" height="100%" >&nbsp;</iframe>
	<!---------///  ///--------->
    </td>
