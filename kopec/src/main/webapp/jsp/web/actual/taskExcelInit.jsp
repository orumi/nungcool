...
function openFrame(tag, obj1, obj2, obj3, obj4){
	...
	if (tag == 'company'){		
		adminContent.location.href="taskExcel.jsp";					
	} else if (tag == 'SBU'){		
		adminContent.location.href="taskExcelDiv.jsp";						
	} else if (tag == 'BSC'){
	    adminContent.location.href="";
	} else if (tag == 'PST'){
	    adminContent.location.href="";
        ...
        <tr> 
          <td colspan="2" valign="top" bgcolor="#FFFFFF"> 
                    ...
                    <tr><td>
					  ...
					  <table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td align="center" background="<%=imgUri%>/jsp/web/images/tap_over_bg.gif" id = 'sub12'><img src="<%=imgUri%>/jsp/web/images/tap_over_point.gif"  id = 'sub13' width="5" height="3" align="absmiddle"> 
                              <strong><a href="#"  onClick = "javascript:openFrame('company', sub11, sub12, sub13, sub14);"><font color="#003399">지표별&nbsp;</font></a></strong></td>
					  ...
					  <table border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            ...
                            <strong><a href="#" onClick = "javascript:openFrame('SBU', sub21, sub22, sub23, sub24);"><font color="#003399">조직별</font></a></strong></td>
            ...
            <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>
		        <iframe frameborder="0" id="adminContent" src="taskExcel.jsp" style="body" width="100%" height="100%" scrolling="no">&nbsp;</iframe>
            </td></tr>
            </table>
          </td>
        </tr>
