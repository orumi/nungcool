...
<SCRIPT>
    ...
    function openDetail(id){
      //task.detailForm.contentId.value=id;
      //task.detailForm.schDate.value=form1.year.options[form1.year.selectedIndex].value+form1.month.options[form1.month.selectedIndex].value;
      //task.detailForm.submit();
...
<table width="98%" border="0" align="center" cellpadding="5"
	...
	<tr bgcolor="#DCEDF6">
		<td align="center" bgcolor="#DCEDF6"><strong><font color="#006699">부 서</font></strong></td>
		<td bgcolor="#FFFFFF">
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr valign="top">
		<td width="43%">
			<iframe frameborder="0" id="list" src="connectionList.jsp?mode=none" style="body" width="100%" height="500">&nbsp;</iframe>
		</td>
		<td width="57%">	
			<iframe frameborder="0" id="task" style="display:none;" src="connectionTask.jsp?mode=none" style="body" width="100%0%" height="500">&nbsp;</iframe>
		</td>
	</tr>
</table>
<!---------///본문 컨텐츠 삽입영역  끝///--------->
