...
<SCRIPT>
    ...
    function chgOrg(level){ 
    	...
    	if ( level == 1 ){ //change level 1    		
    		...
    		form1.secondPart.options[form1.secondPart.length] = new Option(" ==== 전 체 ====    ", "%");
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#A4CBE3">
	<tr bgcolor="#DCEDF6">
		<td width="10%" align="center"><strong><font color="#006699"> 년 월</font></strong></td>
		...
		<td width="10%" align="center"><strong><font color="#006699"> 엑셀등록</font></strong></td>
        <td width="40%" bgcolor="#FFFFFF">
	        ...
	        <a href="javascript:upLoadFile();"><img src="<%=imgUri%>/jsp/web/images/btn_file_upload.gif" alt="파일전송" style="cursor:hand" border="0" align="absmiddle"></a>
        </td>
	</tr>
	<tr bgcolor="#DCEDF6">
		<td align="center" width="10%" bgcolor="#DCEDF6"><strong><font color="#006699">조직선택</font></strong></td>
