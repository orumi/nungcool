  ...
  <tr>
    <td width="160" valign="top" id="leftMenu" style="display:inline"> 
	  <table width="160" height="500" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td height="46"><img src="<%=imgUri %>/jsp/admin/images/submenu_title_01.gif" width="160" height="46"></td>
        </tr>
        <tr> 
          <td valign="top" background="../web/images/submenu_bg.gif">
          <table width="140" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
          <td><a href="javascript:openContents(1);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub1','','<%=imgUri %>/jsp/admin/images/submenu1_01.over.gif',0)"><img src="<%=imgUri %>/jsp/admin/images/submenu1_01.off.gif" name="sub1" width="140" height="25" border="0"></a></td>
              </tr>
              <tr> 
          <td><a href="javascript:openContents(2);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub2','','<%=imgUri %>/jsp/admin/images/submenu1_02.over.gif',0)"><img src="<%=imgUri %>/jsp/admin/images/submenu1_02.off.gif" name="sub2" width="140" height="25" border="0"></a></td>
              </tr>
              <tr> 
          <td><a href="javascript:openContents(3);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sub3','','<%=imgUri %>/jsp/admin/images/submenu1_03.over.gif',0)"><img src="<%=imgUri %>/jsp/admin/images/submenu1_03.off.gif" name="sub3" width="140" height="25" border="0"></a></td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
              </tr>
	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td colspan="2" valign="top" bgcolor="#FFFFFF">
            <!---------///본문 컨텐츠 삽입영역 ///--------->
            <IFRAME id="page1" name="contents1" marginWidth="0" marginHeight="0" src="<%=imgUri%>/jsp/etl/ET010101.jsp" frameBorder="0" width="100%" scrolling="auto" height="100%"></IFRAME>
            <IFRAME id="page2" name="contents2" marginWidth="0" marginHeight="0" src="<%=imgUri%>/jsp/etl/ET010102.jsp" frameBorder="0" width="0" scrolling="auto" height="0"></IFRAME>
            <IFRAME id="page3" name="contents3" marginWidth="0" marginHeight="0" src="" frameBorder="0" width="0" scrolling="auto" height="0"></IFRAME>
            <!---------///본문 컨텐츠 삽입영역  끝///--------->
          </td>
