...
<%
	...
	String getParamTag = request.getParameter("getParamTag");
...
// -----------------------------------------------------------------------------
	...
	function openMeasureTable(year,sbuId,bscId,mid) { 
		...
		var msg = getMyApp("measureTable").openFlex(year,sbuId,bscId,mid);
	...
	function openFile(obj) {
		...
		downForm.submit(); 
		//parent.openMeasureTable(obj.year,obj.sbuId,obj.bscId,obj.mid);
	}	

	function messageCall()	{
		var chkParamTag = "<%=getParamTag%>";
		if(chkParamTag == "1")	{
			openMeasureTable("<%=year%>","<%=sbuId%>","<%=bscId%>","<%=mid%>");
		}
	}
...
<body scroll="no" onLoad="messageCall();">
...
<noscript>
  	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
			id="measureTable" width="100%" height="100%"
			codebase="http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab">
			<param name="movie" value="measureTable.swf" />
			<param name="quality" value="high" />
			<param name="bgcolor" value="#869ca7" />
			<param name="allowScriptAccess" value="sameDomain" />
			<embed src="measureTable.swf" quality="high" bgcolor="#869ca7"
				width="100%" height="100%" name="measureTable" align="middle"
				play="true"
				loop="false"
				quality="high"
				allowScriptAccess="sameDomain"
