...
// -----------------------------------------------------------------------------
	...
	function openScoreIcon(dId,tId,level,year,month) {
		//alert(dId+"/"+tId+"/"+level+"/"+year+"/"+month);
		var msg = getMyApp("ScoreTable").openFlex(dId,tId,level,year,month);
	}
	
	function openMeasureTable(obj) {
		//var temp = obj.year+"/"+obj.sbuId+"/"+obj.bscId+"/"+obj.mid;
		//alert(temp);//+"/"+obj.sbuId="/"+obj.bscId+"/"+obj.mid);
...
<noscript>
  	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
			...
			<param name="movie" value="ScoreTable.swf" />
			<param name="quality" value="high" />
			<param name="bgcolor" value="#869ca7" />
			<param name="allowScriptAccess" value="sameDomain" />
			<embed src="ScoreTable.swf" quality="high" bgcolor="#869ca7"
				width="100%" height="100%" name="ScoreTable" align="middle"
				play="true"
				loop="false"
				quality="high"
				allowScriptAccess="sameDomain"
