...
<!-- angular 1.6.7 -->
<script
	src="<c:url value='/js/ajax/libs/angularjs/1.6.7/angular.min.js'/>"></script>
<script
	src="<c:url value='/js/ncsys/bsc/admin/organizationModule.js'/> "></script>


<script type="text/javascript"
	src="<c:url value='/resource/jqwidgets/scripts/demos.js'/> "></script>
<script type="text/javascript"
	src="<c:url value='/resource/jqwidgets/jqxcore.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resource/jqwidgets/jqxdata.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resource/jqwidgets/jqxbuttons.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resource/jqwidgets/jqxscrollbar.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resource/jqwidgets/jqxpanel.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resource/jqwidgets/jqxtree.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resource/jqwidgets/jqxdragdrop.js'/> "></script>
<script type="text/javascript"
	src="<c:url value='/resource/jqwidgets/jqxcheckbox.js'/> "></script>
					...
					function() {
						...
						$('#jqxTree').on(
								...
								function(event) {
									...
									console.log("item property label:" + item.label + " value:" + item.cid + " id:" + item.id + " pid:" + item.parentElement.id);
			...
			<fieldset style="width: 100%;">
				<div class="form-group">
					...
					<div class="col-md-4" style="padding-right: 1px;">
						<div class="icon-addon addon-md">
							<select class="form-control" id="selMaps" ng-model="entity.selMap" ng-change="changeMapList()">
								<option ng-repeat="option in entity.maps" value="{{option.id}}">{{option.mapname}}</option>
							</select>
						</div>
					</div>
					<div class="col-md-1" style="padding-left: 1px;">
						<a id="btnSave" class="btn btn-primary" style="width: 68px;">
							저 장 </a>
					</div>
					...
					<div class="col-md-1" style="padding-left: 0px;">
						<a ng-click="openProperties()" type="submit"
				...
				<fieldset style="padding-top: 4px;">
					<section>
							...
							<div class="form-group">
								...
								<div class="col-md-1"
									...
									<label class="checkbox"> <input type="checkbox"
										class="form-control" ng-model="selVersion.vernm" /> <i></i>
										글자표시
									</label>
								</div>
								<div class="col-md-1"
						...
						<div class="row" style="margin-top: 4px;float:right;padding-right:24px;">
							<div class="form-group">
								<a id="btnSave" class="btn btn-primary" style="width: 68px;height:28px;">저장 </a>
								<a id="btnSave" class="btn btn-primary" style="width: 68px;height:28px;">전체적용 </a>
								<a id="btnSave" class="btn btn-primary" style="width: 68px;height:28px;">삭제 </a>
							</div>
						</div>
					</section>
				</fieldset>
