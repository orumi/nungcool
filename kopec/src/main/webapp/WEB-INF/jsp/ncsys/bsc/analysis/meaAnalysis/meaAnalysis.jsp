...
var selectMeasureActualsUrl = "<c:url value='/analysis/meaAnalysis/selectMeasureActuals.json'/>";
...
<script type="text/javascript">
    ...
    function actionPerformed(){
		...
		/* $(".ui-jqgrid-title").empty();
		var reVal = "<span class=\"badge\" style=\"cursor:pointer;color:"+txtColor+";background-color: "+bgColor+"!important;\" onclick=\"javascript:alert('');\">"+cellValue+"</span>";
    	$(".ui-jqgrid-title").append("기술전략실 &nbsp;&nbsp;&nbsp;"+reVal); */
    }
		...
		<section id="section">
			<div class="row">
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="padding-right:0px;">
										...
										<div class="widget-content">
											...
											<fieldset>
												<div class="col-md-12" style="padding-right: 1px;border-bottom: 1px solid #c1c1c1;margin-bottom: 12px;">
							                    	<div id="" style="width:100%;height:660px;overflow: scroll;overflow-y: scroll; overflow-x: hidden">
					...
					<!-- new widget -->
					<div class="jarviswidget col-xs-12 col-sm-12 col-md-12 col-lg-12" id="wid-id-0" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" style="padding: 6px;">
						<header style="">
						<h2>실적분석</h2>
						</header>
						<!-- body -->
							...
							<div class="widget-body no-padding" style="">
								...
								<div class="row">
									...
									<div class="widget-content">
										...
										<fieldset>
										<div class="form-group">
											<label class="control-label col-md-12" for="prepend" style="padding-top:6px;" id="lblMeasure">
											...
											<div class="col-md-12" style="padding-right: 1px;border-bottom: 1px solid #ececec;border-left: 1px solid #ececec;margin-bottom: 12px;">
								                    ...
								                    <div id="" style="width:100%;height:200px;overflow: hidden;overflow-y: scroll; overflow-x: hidden">
											...
											<div class="col-md-12" style="padding-right: 1px;border-bottom: 1px solid #ececec;border-left: 1px solid #ececec;margin-bottom: 12px;">
								                    ...
								                    <div id="" style="width:100%;height:150px;overflow: scroll;overflow-y: scroll; overflow-x: hidden">
													<table id="t_state" class="table table-striped table-bordered table-hover dataTable " style="width: 100%;table-layout: fixed;">
								                    	<thead id="th_item">
															<tr role="row">
															<th rowspan="1" colspan="1" style="width:10%;">코드</th>
															<th rowspan="1" colspan="1" style="width:30%;">항목</th>
															<th rowspan="1" colspan="1" style="width:10%;">3월</th>
															<th rowspan="1" colspan="1" style="width:10%;">6월</th>
															<th rowspan="1" colspan="1" style="width:10%;">9월</th>
															<th rowspan="1" colspan="1" style="width:10%;">12월</th>
															</tr>
														</thead>
														<tbody id="tb_item">
										...
										<fieldset>
											<div class="col-md-12" style="padding-right: 1px;border-bottom: 1px solid #ececec;border-left: 1px solid #ececec;margin-bottom: 12px;">
												...
												<div class="widget-body">
													...
													<div class="">
										              <div class="" style="height:200px;" id="statisticsCharts"></div>
										            </div>
	...
	<script type="text/javascript">
       $(document).ready(function() {
            ...
            $("#jqgrid").jqGrid({
                ...
                colNames: ['스코어카드','유형','주기','단위','가중치','S등급','평가등급','지표','득점','','','',''],
                colModel: [
                	{ name: 'name', width: "20%", formatter:scoreFormatter },
                    { name: 'measurement', width: "5%", align: 'center',hidden:true },
                    { name: 'frequency', width: "5%", align: 'center',hidden:true },
                    { name: 'unit', width: "5%", align: 'left',hidden:true },
                    { name: 'weight', width: "5%", align: 'right',hidden:true },
                    { name: 'planned', width: "5%", align: 'center',hidden:true },
                    { name: 'grade', width: "5%", align: 'right', hidden:true },
                    { name: 'id', width: "5%", sortable : false, resizable:false, align: 'center', formatter:btnMeasureFormatter },
                    { name: 'score', width: "5%", align: 'right', hidden:true },
...
/* 	                page : 'pageMaker.cri.crtPage',
            ...
            function scoreFormatter(cellValue, options, rowObject){
				...
				var	reVal = "<font style=\"cursor:pointer;\" onclick=\"javascript:adjustMeasureDetail('" + rowObject.score + "','" + rowObject.actual +"','" + rowObject.grade + "','" + id + "');\"> "+rowObject.name+"</font>";
        ...
        function adjustMeasureDetail(score, actual, grade, id){
        	...
        	//selectMeasureActualsUrl
			var param = new Object();
	      	param.year = $("#selYear").val();
	     	param.id = id;

	     	_xAjax(selectMeasureActualsUrl, param)
	     	.done(function(data){
	 			if("ok_resend" == data.reVal){
	 				$("#lblMeasure").empty();
	 				var tmp = "<font style=\"font-weight:600;\">[성과지표] :</font>"+data.reMeasure.mname+" <font style=\"font-weight:600;padding-left:30px;\">[주기] :</font> "+data.reMeasure.frequency
	 				+"<font style=\"font-weight:600;padding-left:30px;\"> [단위] : </font>"+data.reMeasure.unit
	 				+"<font style=\"font-weight:600;padding-left:30px;\"> [가중치] : </font>"+data.reMeasure.weight
	 				+"<br><font style=\"font-weight:600;\"> [산식] : </font>"+data.reMeasure.equationdefine ;
	 				$("#lblMeasure").append(tmp);
					displayItem(data.selectItemActuals);
	 			}
	     	}).fail(function(error){
	     		console.log("actionEditMeasure error : "+error);
	     	});
        ...
        var itHtml = "<tr role=\"row\" >";
        itHtml += "<td style=\"text-align:center;\">###code###</td>";
        itHtml += "<td style=\"text-align:left;\">###itemname###</td>";
        itHtml += "<td style=\"text-align:right;\">###act03###</td>";
        itHtml += "<td style=\"text-align:right;\">###act06###</td>";
        itHtml += "<td style=\"text-align:right;\">###act09###</td>";
        itHtml += "<td style=\"text-align:right;\">###act12###</td>";
        itHtml += "</tr>";

        function displayItem(itemActuals){
        	for(var i in itemActuals){
        		var tmpHtml = itHtml.replace("###code###",itemActuals[i].code)
    			.replace("###itemname###",itemActuals[i].itemname)
    			.replace("###act03###",itemActuals[i].act03?itemActuals[i].act03:"")
    			.replace("###act06###",itemActuals[i].act06?itemActuals[i].act06:"")
    			.replace("###act09###",itemActuals[i].act09?itemActuals[i].act09:"")
    			.replace("###act12###",itemActuals[i].act12?itemActuals[i].act12:"")
				;
				$("#tb_item").append(tmpHtml);
        	}
        }
