     ...
     function displayPsnEmpScore(psnScore){
    	$("#bscRate").val("");
     	...
     	for(var i in psnScore){
    		...
    		$("#jikgbNm").val(aObj.jikgbNm);
    		$("#empNm").val(aObj.empNm);
    		$("#empNo").val(aObj.empNo);
		...
		<header id="header" style="height:84px;">
			<fieldset style="width: 100%;">
				<div class="form-group">
					...
					<div class="col-md-1" style="padding-right: 6px; padding-left: 1px;">
						<div class="icon-addon addon-md">
							<input type="text" class="form-control" id="empNm"/>
						</div>
					</div>
					<div class="col-md-1" style="padding-right: 6px; padding-left: 1px;width:5%;">
						<div class="icon-addon addon-md">
							<a onClick="javascript:openUserPopup();searchEmp();"  class="btn btn-primary pull-left" style="padding: 6px 18px; margin: 0px 2px;">...</a>
						</div>
					</div>
					<label class="control-label col-md-1" for="prepend"
						style="padding-top: 6px;text-align: right;">직급 </label>
					<div class="col-md-1" style="padding-right: 6px; padding-left: 1px;">
						<div class="icon-addon addon-md">
							<input type="text" class="form-control" id="jikgbNm" />
						</div>
					</div>
					<label class="control-label col-md-1" for="prepend"
					...
					<div class="col-md-1">
					<a onClick="javascript:actionDownloadCSV('tb_psnScore');"  class="btn btn-default pull-left" style="padding: 6px 18px; margin: 0px 2px;">엑셀</a>
					</div>
				</div>
			</fieldset>
			<fieldset style="width: 100%;">
