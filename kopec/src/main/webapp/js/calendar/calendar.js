...
//달력 박스 출력
function showCalendar(day, month, year, id_name, insert_form_name, dateFormType, url)
{
	...
	calStr += "	<tr>\n"
	calStr += "		<td><img src='"+url+"js/calendar/images/cal_top.gif'></td>\n"
	calStr += "	</tr>\n"
	calStr += "	<tr>\n"
	calStr += "		<td background='"+url+"js/calendar/images/cal_bg.gif'><table border=0 cellpadding=0 cellspacing=0 align=center>\n"
	calStr += "			<tr bgcolor=white height='23'>\n";
	calStr += "				<td colspan=2 align='center'>\n";
	calStr += "					<a href='javascript:;' onClick=\"nowm--; if (nowm<0) { nowy--; nowm=11; } showCalendar(nowd,nowm,nowy,'" + id_name + "','" + insert_form_name + "','" + dateFormType + "','"+url+"');\">\n";
	calStr += "					<img src='"+url+"js/calendar/images/btn_pre.gif' border='0' align='absmiddle'></a>\n";
	calStr += "				</td>\n";
	calStr += "				<td colspan=3 align='center'>\n";
	calStr += "					<strong>" + year + "</strong>년 <strong>"+monthDate[month].toUpperCase()+"</strong>월\n";
	calStr += "				</td>\n";
	calStr += "				<td colspan=2 align='center'>\n";
	calStr += "					<a href='javascript:;'  onClick=\"nowm++; if (nowm>11) { nowy++; nowm=0; } showCalendar(nowd,nowm,nowy,'" + id_name + "','" + insert_form_name + "','" + dateFormType + "','"+url+"');\">\n";
	calStr += "					<img src='"+url+"js/calendar/images/btn_next.gif' border='0' align='absmiddle'>\n";
	calStr += "					</a>\n";
	calStr += "				</td>\n";
	calStr += "			</tr>\n";
	...
	for (var i=0;i<monthDays[month];i++) {
		...
		if(dateFormType == null || dateFormType == "" || dateFormType == undefined){ //기본형
			...
			var tmpMonth = monthDate[month].toUpperCase();
			if (tmpMonth<10){ tmpMonth="0"+tmpMonth };

			var tmpDate = month_date;
			if (tmpDate<10) { tmpDate="0"+tmpDate;}
			insert_date = year + tmpMonth  + tmpDate;
		}
	...
	calStr += "					<a href=\"javascript:calenderBoxClose('" + id_name + "');\"><img src='"+url+"js/calendar/images/close.gif' border='0'></a>\n";
	calStr += "				</td>\n";
	calStr += "			</tr>\n";
	calStr += "		</table></td>\n";
	calStr += "	</tr>\n";
	calStr += "	<tr>\n"
	calStr += "		<td><img src='"+url+"js/calendar/images/cal_bottom.gif'></td>\n"
	calStr += "	</tr>\n"
	calStr += "</table><BR>";
