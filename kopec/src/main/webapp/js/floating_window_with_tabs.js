	...
	*/	
	...
	function addTabs(inputObj,tabs,noCloseButton,noMinimizeButton)
	{
		...
		div.style.zIndex = 1000;
		div.style.position = 'relative';
		div.style.height='23px';  // tab height control by mck
		...
		for(var no=0;no<tabs.length;no++){			
			...
			tabDiv.style.top = '6px';  // tab height control by mck;
			...
			//alert(tabDiv.style.width);
			//alert(tabImg.style.left);
	...
	function initFloatingWindowWithTabs
	(windowID,tabs,windowHeight,windowWidth,leftPos,topPos,noScrollbars,noResize,noStatusBar,noCloseButton,noMinimizeButton,noMove)
	{
