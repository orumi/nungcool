        ...
        <tr>
            <td width="48%">
                ...
                <div class="text-right">
                    ...
                    <button class="btn btn-xs btn-white btn-default btn-round " id="delete">
                        <i class="ace-icon fa fa-trash-o bigger-120 orange"></i>
                        삭제
                    </button>
                    <button class="btn btn-xs btn-white btn-default btn-round " id="cancel">
            ...
            <td width="48%">
                ...
                <div class="text-right">
                    <button class="btn btn-xs btn-white btn-default btn-round " id="add2">
                        <i class="ace-icon fa fa-pencil align-top bigger-125"></i>
                        추가
                    </button>
                    <button class="btn btn-xs btn-white btn-default btn-round " id="save2">
                        <i class="ace-icon fa fa-floppy-o bigger-120 blue"></i>
                        저장
                    </button>
                    <button class="btn btn-xs btn-white btn-default btn-round " id="delete2">
                        <i class="ace-icon fa fa-trash-o bigger-120 orange"></i>
                        삭제
                    </button>
                    <button class="btn btn-xs btn-white btn-default btn-round " id="cancel2">
                        <i class="ace-icon fa fa-times red2"></i>
                        취소
                    </button>
                </div>
