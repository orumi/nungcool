...
<script>
    ...
    function actionSelectResult(smpid) {
        ...
        $.ajax({
            type: "post",
            data: {"mode": "", "reqid": $("#reqid").val(), "smpid": $("#current_smpid").val(), "kolasyn":$("#kolasyn").val() },
            async: false,
...
<script>
    ...
    function goList() {
        location.replace("<c:url value='/detail/reqList.do?sub=detail&menu=reqList'/>");
    }
    
    function actionChangeKolas(){
    	if("Y" == $("#kolasyn").val()){
    		alert("KOLAS인정 항목 이외 시험항목은 KOLAS성적서로 발급이 불가하오니 \n'일반'으로 선택하여 주시기 바랍니다.");
    	}
    }
    ...
    <div class="title_route">
        ...
        <p class="route">
            <img src="<c:url value='/images/exam/ico/home.gif'/>" alt="홈"/> <img
                src="<c:url value='/images/exam/bg/gt.gif'/>" alt=""/> 시험신청 <img
                src="<c:url value='/images/exam/bg/gt.gif'/>" alt=""/> <span>일반의뢰 시험</span></p>
    </div>

    <div class="template_btn" style="height:34px; <c:if test="${stateNm != 'show'}"> display : none </c:if>">
        <div type="button" id="btn_insertTemplet" class="btn btn-primary btn-normal"
             style="height:27px;padding:2px 12px !important; float:right;margin-right:3px;"
             onclick="javascript:actionPerformed('insertTemplete');">
            템플릿 저장하기
        </div>

        <div type="button" id="btn_adjustTemplet" class="btn btn-primary btn-normal"
             style="height:27px;padding:2px 12px !important; float:right;margin-right:3px;"
             onclick="javascript:actionPerformed('adjustTemplete');">
            템플릿 적용하기
        </div>

        <div type="button" id="btn_delRequest" class="btn btn-warning btn-normal"
             style="height:27px;padding:2px 12px !important; float:right;margin-right:8px;"
             onclick="javascript:actionPerformed('deleteRequest');">
            의뢰정보 삭제
        </div>
            ...
            <div id="" class="table_w_in">
                <p class="close_btn">
                    <a href="javascript:actionDivWindow('div1_close');"><img id="icon_div1_close"
                                                                             src="<c:url value='/images/exam/btn/btn01.gif'/>"
                                                                             alt=""/></a>
                    <a href="javascript:actionDivWindow('div1_open');"><img id="icon_div1_open"
                                                                            src="<c:url value='/images/exam/btn/btn02.gif'/>"
                                                                            alt=""/></a>
                </p>
                ...
                <div id="div1_win_content" class="table_bg">
                    <table summary="신청자정보" class="table_w">
                        ...
                        <tr>
                            ...
                            <td><input id="mngname" name="mngname" type="text" value="" class="h30"
                                       style="width:243px;"/></td>
                            <th>담당부서 <span class="surely01">*</span></th>
                            <td><input id="mngdept" name="mngdept" type="text" value="" class="h30"
                                       style="width:243px;"/></td>
                        </tr>
                        <tr>
                            <th>휴대폰 <span class="surely01">*</span></th>
                            <td>
                                <input type="text" id="mnghp" name="mnghp" value="" class="h30"
                                       style="width:108px;" placeholder="010-0000-0000"/>
                                <div class="ex">
                                    <label>ex) 010-0000-0000</label>
                                </div>
                            </td>
                            <th>이메일 <span class="surely01">*</span></th>
                            <td><input name="mngemail" id="mngemail" type="text" value="" class="h30"
                                       style="width:243px;ime-mode:inactive"/></td>
                        </tr>
                        <tr>
                            <th class="b_B_none">전화번호 <span class="surely01">*</span></th>
                            <td class="b_B_none">
                                <input type="text" id="mngphone" name="mngphone" value="" class="h30"
                            ...
                            <td class="b_B_none">
                                <input type="text" id="fax" name="fax" value="" class="h30" style="width:108px;"
                ...
                <div id="div2_win_content" class="table_bg">
                    <table summary="성적서 기본정보" class="table_w">
                        ...
                        <tr>
                            <td colspan="4" style="padding:0px;">
                                <table tyle="width:100%">
                                    ...
                                    <tr>
                                        <th class="table_k">시험성적서 원본</th>
                                        <td class="table_k">
                                            <select name="langtype" id="langtype" class="h30"
                                                    style="width:130px;">
                                                <option value="K"> 국문 1부</option>
                                                <option value="E"> 영문 1부</option>
                                            </select>
                                        </td>
                                        <th class="table_k">성적서 용도</th>
                                        <td class="table_k">
                                            <select name="usage" id="usage" class="h30" style="width:130px;">
                                        ...
                                        <th class="table_k">일반/KOLAS</th>
                                        <td class="table_k">
                                            <select name="kolasyn" id="kolasyn" class="h30"
                                                    style="width:80px;" onchange="javascript:actionChangeKolas();">
                                                <option value="N">일반</option>
                                                <option value="Y">KOLAS</option>
                                            </select>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="copycnt" id="copycnt" class="h30" style="width:100px;"
                                    ...
                                    <option value="<%=cnt+1%>"><%=cnt + 1%>
                                    </option>
                                    <% } %>
                                    <option value="etc">기타</option>
                                </select>

                                <input id="copycnt_etc" name="copycnt_etc" type="text" class="h30"
                            ...
                            <td>
                                <div style="float:left">
                                    <select id="itemafter" name="itemafter" class="h30"
                                            style="width:130px; margin-top: 7px">
                                        <option value="1">폐기</option>
                                        <option value="2">보관</option>
                                    </select>
                                </div>
                                <div style="float:right; text-align:right">
                                    &nbsp;&nbsp;&nbsp;<font color="red" size="2">단, 시험완료 후 시료보관 요청 시 <br/></font>
                                    &nbsp;&nbsp;&nbsp;<font color="red" size="2">30일 보관수수료 5,000원이 가산</font>
                                </div>
                        ...
                        <tr>
                            <th>성적서 수령</th>
                            <td>
                                <select id="sendstype" name="sendstype" class="h30"
                                        style="width:100px; margin-bottom:6px; margin-top:3px;">
                                    <option value="E">온라인</option>
                                    <option value="P">우편</option>
                                </select>
                            </td>
                            <th>연구장비 공동<br/>활용 지원사업</th>
                            <td>
                                <div style="float:left">
                                    <select id="commonuse" name="commonuse" class="h30"
                                            style="width:100px; margin-bottom:6px; margin-top:3px;">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div style="
    									...
    									padding-top: 16px;
									">
                                    <input type="radio" id="rcvtype" name="rcvtype" value="1"
                                           onclick="javascript:actionClickRcv();"/> 신청자 정보와 동일
                                    <input type="radio" id="rcvtype" name="rcvtype" value="2" class="m_L40"
                                           onclick="javascript:actionClickRcv();"/> 신규등록
                                </div>
                                <div class="div_table_sub_w">
                                    <table id="tbl_rcv" class="table_sub_w" style="display:none;">
                                        ...
                                        <tr>
                                            ...
                                            <td><input id="rcvcompany" name="rcvcompany" type="text" value=""
                                                       class="h30" style="width:220px;"/></td>
                                            <th class="cor01">대표자 <span class="surely01">*</span></th>
                                            <td><input id="rcvceo" name="rcvceo" type="text" value=""
                                                       class="h30" style="width:220px;"/></td>
                                        </tr>
                                        <tr>
                                            <th class="cor01" style="height:70px;">주소 <span class="surely01">*</span>
                                            </th>
                                            <td colspan="3">
                                                <input id="rcvzipcode" name="rcvzipcode" type="text"
                                                       value="" class="h30" style="width:60px;"/>
                                                <a href="#"><img id="btn_zipcode1" name="btn_zipcode1"
                                                                 src="<c:url value='/images/exam/btn/btn_addr.gif'/>"
                                                                 alt="우편번호찾기" style="border:0px;"/></a>
                                                <br>
                                                <input id="rcvaddr1" name="rcvaddr1" type="text" value=""
                                                       class="h30" style="width:365px; margin-top:3px;"/>
                                                <input id="rcvaddr2" name="rcvaddr2" type="text" value=""
                                                       class="h30" style="width:180px; margin-top:3px;"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="cor01">담당자 <span class="surely01">*</span></th>
                                            <td><input id="rcvmngname" name="rcvmngname" type="text" value=""
                                                       class="h30" style="width:220px;"/></td>
                                            <th class="cor01">담당부서</th>
                                            <td><input id="rcvdept" name="rcvdept" type="text" value=""
                                                       class="h30" style="width:220px;"/></td>
                                        </tr>
                                        <tr>
                                            <th class="cor01">휴대폰 <span class="surely01">*</span></th>
                                            <td>
                                                <input type="text" id="rcvhp" name="rcvhp" value=""
                                                       class="h30" style="width:108px;"
                                                       placeholder="010-0000-0000"/>
                                            </td>
                                            <th class="cor01">이메일 <span class="surely01">*</span></th>
                                            <td><input type="text" id="rcvemail" name="rcvemail" value=""
                                                       class="h30" style="width:220px;"/></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="rcvphone" name="rcvphone" value=""
                                                       class="h30" style="width:108px;"
                                                       placeholder="010-0000-0000"/>
                                            </td>
                                            ...
                                            <td style="border-right: 1px solid #FFFFFF !important;">
                                                <input type="text" id="rcvfax" name="rcvfax" value=""
                                                       class="h30" style="width:108px;"
                                                       placeholder="010-0000-0000"/>
                                            </td>
                                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <table id="tbl_tax" class="table_sub_w" style="display:none;">
                                    ...
                                    <tr>
                                        <th class="cor01">업체명 <span class="surely01">*</span></th>
                                        <td><input id="taxcompany" name="taxcompany" type="text" value=""
                                                   class="h30" style="width:220px;"/></td>
                                        <th class="cor01">대표자 <span class="surely01">*</span></th>
                                        <td><input id="taxceo" name="taxceo" type="text" value="" class="h30"
                                                   style="width:220px;"/></td>
                                    </tr>
                                    <tr>
                                        <th class="cor01" style="height:70px;">주소 <span
                                                class="surely01">*</span></th>
                                        <td colspan="3">
                                            <input id="taxzipcode" name="taxzipcode" type="text" value=""
                                                   class="h30" style="width:60px;"/>
                                            <a href="#"><img id="btn_zipcode2" name="btn_zipcode2"
                                                             src="<c:url value='/images/exam/btn/btn_addr.gif'/>"
                                                             alt="우편번호찾기" style="border:0px;"/></a>
                                            <br>
                                            <input id="taxaddr1" name="taxaddr1" type="text" value=""
                                                   class="h30" style="width:365px; margin-top:3px;"/>
                                            <input id="taxaddr2" name="taxaddr2" type="text" value=""
                                                   class="h30" style="width:180px; margin-top:3px;"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="cor01">사업자번호 <span class="surely01">*</span></th>
                                        <td><input id="taxbizno" name="taxbizno" type="text" value=""
                                                   class="h30" style="width:220px;"/></td>
                                        <th class="cor01">업태 <span class="surely01">*</span></th>
                                        <td><input type="text" id="taxbiztype" name="taxbiztype" value=" "
                                                   class="h30" style="width:220px;"/></td>
                                    </tr>
                                    <tr>
                                        <th class="cor01">담당자 <span class="surely01">*</span></th>
                                        <td><input type="text" id="taxmngname" name="taxmngname" value=" "
                                                   class="h30" style="width:220px;"/></td>
                                        <th class="cor01">담당부서</th>
                                        <td><input id="taxdept" name="taxdept" type="text" value=""
                                                   class="h30" style="width:220px;"/></td>
                                    </tr>
                                    <tr>
                                        <th class="cor01">휴대폰 <span class="surely01">*</span></th>
                                        <td>
                                            <input type="text" id="taxhp" name="taxhp" value="" class="h30"
                                                   style="width:108px;" placeholder="010-0000-0000"/>
                                        </td>
                                        <th class="cor01">이메일 <span class="surely01">*</span></th>
                                        <td><input id="taxemail" name="taxemail" type="text" value=""
                                                   class="h30" style="width:220px;"/></td>
                                    </tr>
                                    <tr>
                                        <th class="cor01">전화번호 <span class="surely01">*</span></th>
                                        <td>
                                            <input type="text" id="taxphone" name="taxphone" value=""
                                                   class="h30" style="width:108px;"
                                                   placeholder="010-0000-0000"/>
                                        </td>
                                        <th class="b_B_none cor01">팩스번호</th>
                                        <td class="b_B_none">
                                            <input type="text" id="taxfax" name="taxfax" value="" class="h30"
                                                   style="width:108px;" placeholder="010-0000-0000"/>
                                        </td>
                                    </tr>
                                </table>
                ...
                <div id="div2_btn" style="width:100%;text-align: center;margin-top:6px;">
                    <div type="button" id="btn_setRequest" class="btn btn-primary btn-normal"
                         style="height:32px;padding:1px 24px 1px 24px !important; margin-right:8px; font-weight:700 !important; font-size:16px !important"
                         onclick="javascript:actionPerformed('setRequest');">
                        저 장
                    </div>
                </div>
...
<div class="right_warp" id="div_detail" style="display:none;">
    ...
    <div class="table_warp">
        ...
        <div class="table_w_in">
            ...
            <h4 class="title01">
                <span class="txt">시료정보</span>
						<span id="div_sample" class="btn_r">
							<a href="javascript:actionPerformed('addSample');"><img id="btn_addSample"
                                                                                    src="<c:url value='/images/exam/btn/btn_sample01.gif'/>"
                                                                                    alt="시료추가"
                                                                                    style="border:0px;"/></a>
							<a href="javascript:actionPerformed('copySample');"><img id="btn_copySample"
                                                                                     src="<c:url value='/images/exam/btn/btn_sample02.gif'/>"
                                                                                     alt="시료복사"
                                                                                     style="border:0px;"/></a>
						</span>
            </h4>
            <!-- table_bg -->
            <div class="table_bg"
                 style="width:100%;height:200px;overflow: scroll;overflow-y: scroll; overflow-x: hidden">
            ...
            <table summary="시료명칭/유종제품" class="table_w " style="margin-top: 0px;">
                ...
                <tr>
                    ...
                    <td class="bor_T_color01 bor_R_color01 bor_B_color01 ">
                        <input type="text" id="txt_samplenm" name="txt_samplenm" value="" class="h30"
                               style="width:42%"/>
                        /
            ...
            <h4 class="title01">
                <span class="txt">검사항목</span>
						<span id="div_items" class="btn_r">
							<a href="javascript: actionPerformed('openSelectItems');"><img id="btn_addItems"
                                                                                           src="<c:url value='/images/exam/btn/btn_article01.gif'/>"
                                                                                           alt="항목추가"
                                                                                           style="border:0px;"/></a>
							<a href="javascript: actionPerformed('deleteItems')"><img id="btn_delItems"
                                                                                      src="<c:url value='/images/exam/btn/btn_article02.gif'/>"
                                                                                      alt="항목삭제"/></a>
							<a href="javascript: actionPerformed('insertItemsCopy')"><img id="btn_copyItems"
                                                                                          src="<c:url value='/images/exam/btn/btn_article03.gif'/>"
                                                                                          alt="항목복사"/></a>
                            <!--
							...
							<a href="javascript: actionPerformed('updateItemsCopy');"><img id="btn_copySameItems" src="<c:url value='/images/exam/btn/btn_article05.gif'/>" alt="동일항목 속성일괄복사"/></a>
							 -->
							<a href="javascript: actionPerformed('saveItems');" class="last"><img
                                    id="btn_saveItems" src="<c:url value='/images/exam/btn/btn_save01.gif'/>"
                                    alt="저장"/></a>
						</span>
            </h4>
            <!-- table_bg -->
            <div id="div_items" name="div_items" class="table_bg" style="width:100%;height:550px; overflow:hidden;">
                <iframe id="ifrmResults" src="<c:url value='/req/testIframe.do'/>"
                        style="width:100%; height:550px; padding:0px; border: 0px;" scrolling="no"></iframe>
            </div>
            <!-- //table_bg  -->
        </div>
        <!-- //table_w_in -->
    ...
    <form id="frmFile" name="frmFile" enctype="multipart/form-data">
        ...
        <div class="table_warp">
            ...
            <div id="" class="table_w_in">
                ...
                <!-- table_bg -->
                <div class="table_bg"
                     style="width:100%;height:80px;overflow: scroll;overflow-y: scroll; overflow-x: hidden">
                ...
                <table class="table_h">
                    ...
                    <tr>
                        <td colspan="3">
                            ...
                            <img id="btn_addFiles" onclick="javascript:actionFile();"
                                 src="<c:url value='/images/exam/btn/btn_save01.gif'/>" alt="저장" align="right"
    ...
    <c:if test="${stateNm == 'show'}">
        <div style="width:100%;text-align: center;">
            <div type="button" id="btn_confirm" class="btn btn-primary btn-normal"
                 style="height:38px;padding:8px 24px 1px 24px !important; margin-right:8px; font-weight:700 !important; font-size:16px !important"
                 onclick="javascript:actionPerformed('requestConfirm');">
                접수 완료
            </div>
            <!--
