...
<script>
    ...
    function sameAddr() {
        ...
        if ($(this).is(":checked") == true) {
            $("#userAddrNum").val($("#compAddrNum").val());
...
<form id="form_joinMember" name="form_joinMember" action="<c:url value='/member/joinMemberAction.do'/>" method="post"
      class="formClass">
    <!-- right_warp(오른쪽 내용) -->
    <div class="right_warp">
        <div class="title_route">
            ...
            <p class="route">
                <img src="<c:url value='/images/exam/ico/home.gif'/>" alt="홈"/> <img
                    ...
                    src="<c:url value='/images/exam/bg/gt.gif'/>" alt=""/> <span>회원가입</span>
            </p>
        </div>
        ...
        <div class="table_bg m_B10">
            <table summary="사용자정보" class="table_w">
                ...
                <tr>
                    <th class="font13"><span style="color:red;">* </span>아이디</th>
                    <td class="" colspan="3">
                        <input id="userId" name="userId" type="text" class="h30 txt_color02" placeholder="아이디를 입력하세요"
                               style="width:150px;" onkeyup="this.value=this.value.replace(/[^a-z0-9]/gi,'');"/>&nbsp;
                        <a href="javascript:idValidation()"><img src="<c:url value='/images/exam/btn/btn_check05.gif'/>"
                                                                 alt="사용여부확인"/></a>&nbsp;
                    </td>
                </tr>
                <tr>
                    <th class="font13"><span style="color:red;">* </span>비밀번호</th>
                    <td class=""><input id="psword" name="psword" type="password" value="" class="h30"
                                        onfocus="this.value=''"
                                        style="width:150px;"/>

                    </td>
                    <th class="font13"><span style="color:red;">* </span>비밀번호 확인</th>
                    <td class=""><input id="psConfirm" name="psConfirm" type="password" value="" class="h30"
                                        onfocus="this.value=''"
                ...
                <tr>
                    ...
                    <td class=""><input id="userNm" name="userNm" type="text" value="" class="h30"
                                        onfocus="this.value=''"
                                        style="width:150px;"/></td>

                    <th class="font13"><span style="color:red;">* </span>담당부서</th>
                    <td class=""><input id="departNm" name="departNm" type="text" value="" class="h30"
                                        onfocus="this.value=''"
                                        style="width:150px;"/></td>
                </tr>
                <tr>
                    ...
                    <td class="">
                        <input id="teleNum" name="teleNum" type="text" value="" class="h30" maxlength="11"
                               onkeyup="this.value=this.value.replace(/[^0-9]/gi,'');"
                               style="width:150px;">
                    </td>
                    <th class="font13"><span style="color:red;">* </span>휴대폰</th>
                    <td class="">
                        <input id="mobile" name="mobile" type="text" value="" class="h30" maxlength="11"
                               onkeyup="this.value=this.value.replace(/[^0-9]/gi,'');"
                               style="width:150px;"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="">
                        <input id="faxNum" name="faxNum" type="text" value="" class="h30" style="width:150px;"
                               onkeyup="this.value=this.value.replace(/[^0-9]/gi,'');"/>
                    </td>
                    <th class="font13"><span style="color:red;">* </span>이메일</th>
                    <td class="">
                        <input id="email" name="email" type="email" value="" class="h30" style="width:150px;"
                ...
                <tr>
                    ...
                    <td class="" colspan="3" style="border-bottom:none; ">
                        <input id="userAddrNum" name="userAddrNum" type="text" value="" class="h30" readonly="readonly"
                               style="width:60px;"/> &nbsp;
                ...
                <tr>
                    <td class="" colspan="3" style="padding-top:0">
                        <input id="userAddr1" name="userAddr1" type="text" value="" class="h30" style="width:357px;"
                               readonly="readonly" placeholder="우편번호 찾기를 이용해 등록해 주세요"/>
                        &nbsp;
                        <input id="userAddr2" name="userAddr2" type="text" value="" class="h30" style="width:220px;"/>&nbsp;
                    </td>
                </tr>
            </table>
        </div>
        ...
        <!-- //재직증명서 -->
        <p class="txt_C"><a href="javascript:finallyJoinMember();"><img
                src="<c:url value='/images/exam/btn/btn_admin.gif'/>" alt="회원가입"/></a></p>
