...
<%@ page import="exam.com.report.model.CopyReportVO" %>
<%@ page import="exam.com.report.model.CopyRequestVO" %>
...
<script>
    ...
    function fnAjaxSubmit(){
        ...
        $("#reportForm").ajaxSubmit({
            ...
            url: "<c:url value='/report/mergeCopyRequestSave.json'/>",
            type: 'POST',
...
<div class="right_warp">
    ...
    <div id="" class="table_w_in">
        ...
        <form id="reportForm" name="reportForm" action="<c:url value='/report/mergeCopyRequestSave.do'/>" method="post">
            <!-- hidden 정보들-->
            <input id="reportid" name="reportid" type="text" readonly="true" value="${reportList.reportid}" style="display: none"/>
            <input id="reqid" name="reqid" type="text" readonly="true" value="${reportList.reqid}" style="display: none"/>
            <input id="acceptno" name="acceptno" type="text" readonly="true" value="${reportList.acceptno}" style="display: none"/>
            <input id="reportno" name="reportno" type="text" readonly="true" value="${reportList.reportno}" style="display: none"/>
            <input id="type" name="type" type="text" readonly="true" value="M" style="display: none"/>
            <input id="kolasyn" name="kolasyn" type="text" readonly="true" value="${reportList.kolasyn}" style="display: none"/>
            <input id="sendstype" name="sendstype" type="text" readonly="true" value="E" style="display: none"/>
                                ...
                                <table id="mergeListTable" class="table_sub_w" style="margin-top: 3px">
                                    ...
                                    <tr>
                                        <td style="text-align: center">
                                            <input name="mergereqid" value="${merge.reqId}" type="checkbox"/>
                                        </td>
        ...
        <p id="div2_btn" class="txt_C" style="padding-top:8px;">
            <a href="javascript:fnAjaxSubmit();"> <img id="btn_setrequest" src="${pageContext.request.contextPath}/images/exam/btn/btn_save02.gif" alt="저장">
            </a>
        </p>
