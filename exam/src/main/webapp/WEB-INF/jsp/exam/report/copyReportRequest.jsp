...
<script>
    ...
    function fnAjaxSubmit() {
        ...
        $("#reportForm").ajaxSubmit({
            url: "<c:url value='/report/copyReportRequestSave.json'/>",
            type: 'POST',
    ...
    function copycntHandler(){
        var copycnt = $("#copycnt").val();
        copycnt = copycnt*1;
        if(copycnt < 1){
            alert("시험성적서 부분은 최소 1부 이상을 만족해야 합니다.");
            $("#copycnt").val(1);
        } else {
            var price = copycnt * 5500;
    ...
    <div id="" class="table_w_in">
        <p class="close_btn">
            <a href="javascript:actionDivWindow('div1_close');"><img id="icon_div1_close"
                                                                     src="${pageContext.request.contextPath}/images/exam/btn/btn01.gif" alt=""></a>
            <a href="javascript:actionDivWindow('div1_open');"><img id="icon_div1_open"
                                                                    src="${pageContext.request.contextPath}/images/exam/btn/btn02.gif" alt=""
        ...
        <form id="reportForm" name="reportForm" action="<c:url value='/report/copyReportRequestSave.do'/>"
              method="post">
            <!-- hidden 정보들-->
            <input id="reportid" name="reportid" type="text"  value="${reportList.reportid}" style="display: none"/>
            <input id="reqid" name="reqid" type="text"  value="${reportList.reqid}" style="display: none"/>
            <input id="acceptno" name="acceptno" type="text"  value="${reportList.acceptno}" style="display: none"/>
            <input id="reportno" name="reportno" type="text"  value="${reportList.reportno}" style="display: none"/>
            <input id="type" name="type" type="text"  value="C" style="display: none"/>
            <input id="kolasyn" name="kolasyn" type="text"  value="${reportList.kolasyn}" style="display: none"/>
            <input id="sendstype" name="sendstype" type="text"  value="E" style="display: none"/>
...
<%--                            <select name="copycnt" id="copycnt" class="h30" style="width:100px;"
                            ...
                            <input type="number" id="copycnt" name="copycnt" class="h30"
                                   style="width:150px;" value="1" minlength="0" onchange="copycntHandler()"/>(부)
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="reportprice" name="reportprice" type="text" class="h30"
                                   style="width:150px;" readonly="true" value="5500">(\)
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <select id="pricechargetype" name="pricechargetype" class="h30"
                                ...
                                <option value="-1">##선택##</option>
                                <option value="26" <c:if test="${reportList.pricechargetype  eq '26'}">selected</c:if>>
                                    청구
                                </option>
                                <option value="27" <c:if test="${reportList.pricechargetype  eq '27'}">selected</c:if>>
                                    카드
                                </option>
                                <option value="28" <c:if test="${reportList.pricechargetype  eq '28'}">selected</c:if>>
                                    영수
                                </option>
                            </select>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <a href="#"><img id="btn_zipcode2" name="btn_zipcode2"
                                                         src="${pageContext.request.contextPath}/images/exam/btn/btn_addr.gif" alt="우편번호찾기"
                                                         style="border:0px;"
        ...
        <p id="div2_btn" class="txt_C" style="padding-top:8px;">
            <a href="javascript:fnAjaxSubmit();"> <img id="btn_setrequest" src="${pageContext.request.contextPath}/images/exam/btn/btn_save02.gif"
                                                       alt="저장"> </a>
        </p>
