...
<div class="right_warp">
    ...
    <div id="" class="table_w_in">
        ...
        <form id="reportForm" name="reportForm" action="<c:url value='/report/reviseCopyListUpdate.do'/>" method="post">
            <!-- hidden 정보들-->
            ...
            <input id="type" name="type" type="text" hidden="true" value="C" style="display: none"/>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input id="rcvzipcode" name="rcvzipcode" type="text"
                                                   value="${reportList.rcvzipcode}" class="h30" style="width:60px;" readonly="true">
                                            <%--<a href="#"><img id="btn_zipcode1" name="btn_zipcode1"
                                                             ...
                                                             role="button"></img></a>--%>
                                            <br>
                                            <input id="rcvaddr1" name="rcvaddr1" type="text"
                                                   value="${reportList.rcvaddr1}"
                                                   class="h30" style="width:365px; margin-top:3px;" readonly="true">
                                            <input id="rcvaddr2" name="rcvaddr2" type="text"
                                                   value="${reportList.rcvaddr2}"
                                                   class="h30" style="width:140px; margin-top:3px;float:right;" readonly="true">
                                        </td>
                                    </tr>
                                    <tr>
        ...
        <p id="div2_btn" class="txt_C" style="padding-top:8px;">
            <a href="javascript:save();"> <img id="btn_setrequest" src="/exam/images/exam/btn/btn_save02.gif" alt="저장">
            </a>
        </p>
