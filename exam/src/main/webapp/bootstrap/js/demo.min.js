$("#divHeader").append('<div class="demo"><span id="demo-setting"><i class="fa fa-cog txt-color-blueDark"></i></span> <form><legend class="no-padding margin-bottom-5">&nbsp;스킨선택</legend><h6 class="margin-top-10 semi-bold margin-bottom-5"></h6> <section id="smart-styles"><a href="javascript:void(0);" id="smart-style-0" data-skinlogo="images/logo/logo.png" class="btn btn-block btn-xs txt-color-white margin-right-5" style="background-color:#4E463F;"><i class="fa fa-check fa-fw" id="skin-checked"></i>스마트 기본</a><a href="javascript:void(0);" id="smart-style-1" data-skinlogo="images/logo/logo-white.png" class="btn btn-block btn-xs txt-color-white" style="background:#3A4558;">다크 초콜릿</a> <a href="javascript:void(0);" id="smart-style-2" data-skinlogo="images/logo/logo-blue.png" class="btn btn-xs btn-block txt-color-darken margin-top-5" style="background:#fff;">울트라 라이트</a><a href="javascript:void(0);" id="smart-style-3" data-skinlogo="images/logo/logo-pale.png" class="btn btn-xs btn-block txt-color-white margin-top-5" style="background:#f78c40">스마트 구글</a><a href="javascript:void(0);" id="smart-style-4" data-skinlogo="images/logo/logo-pale.png" class="btn btn-xs btn-block txt-color-white margin-top-5" style="background: #bbc0cf; border: 1px solid #59779E; color: #17273D !important;">픽셀스메쉬</a> </section></form> </div>');
