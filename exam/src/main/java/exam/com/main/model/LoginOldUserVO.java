package exam.com.main.model;

public class LoginOldUserVO {
	...
	public void setOldmemid(String oldmemid) {
		this.oldmemid = oldmemid; 
	}
	public String getOldmemid() {
		return oldmemid; 
	}
	...
	public void setEceoname(String eceoname) {
		this.eceoname = eceoname; 
	}
	public String getEceoname() {
		return eceoname; 
	}
