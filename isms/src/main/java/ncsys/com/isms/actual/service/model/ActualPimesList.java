...
public class ActualPimesList {
	...
	private String cntpln;
	private String cntact;
	private String cntagg;
	
	
	
	public String getCntpln() {
		return cntpln;
	}
	public void setCntpln(String cntpln) {
		this.cntpln = cntpln;
	}
	public String getCntact() {
		return cntact;
	}
	public void setCntact(String cntact) {
		this.cntact = cntact;
	}
	public String getCntagg() {
		return cntagg;
	}
	public void setCntagg(String cntagg) {
		this.cntagg = cntagg;
	}
