...
public class EgovBBSManageController {
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/selectBoardLatestList.do")
    public String selectBoardLatestArticles(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
		...
		boardVO.setRecordCountPerPage(8);
		Map<String, Object> map = bbsMngService.selectBoardLatestArticles(boardVO, master.getBbsAttrbCode());//2011.09.07
		...
		return "egovframework/com/cop/bbs/EgovNoticeLatestList";
    }
    ...
    public String selectBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, BindingResult result, ModelMap model) throws Exception {
		LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
