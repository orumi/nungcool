...
public class BBSManageDAO extends EgovComAbstractDAO {
     ...
     */
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectBoardLatestArticleList(BoardVO boardVO) throws Exception {
	return (List<BoardVO>) list("BBSManageDAO.selectBoardLatestArticleList", boardVO);
    }
