...
<table width="717" cellpadding="8" cellspacing="1" class="table-search" border="0">
 <tr>
        ...
        <td width="80%">
          <table border="0" cellspacing="0" cellpadding="0" align="left">
            <tr>
              ...
              <td width="5">&nbsp;</td>
              <td><span class="button"><a href="<c:url value='/sym/prm/EgovProgramListRegist.do'/>" onclick="insertProgramListManage(); return false;"><spring:message code="button.create" /></a></span></td>
              <td width="5">&nbsp;</td>
              <td><span class="button"><a href="#LINK" onclick="fDeleteProgrmManageList(); return false;"><spring:message code="button.delete" /></a></span></td>
              <td width="50">&nbsp;</td>
            </tr>
          </table>
        </td>
...
<table width="717" cellspacing="0" cellpadding="0" class="table-line" style="table-layout:fixed" summary="프로그램목록관리 목록으로 프로그램파일명, 프로그램명, url,프로그램설명 으로 구성">
