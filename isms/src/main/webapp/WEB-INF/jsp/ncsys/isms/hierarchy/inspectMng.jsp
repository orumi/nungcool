    ...
    <script type="text/javascript">
       $(document).ready(function() {
            ...
            $("#jqgrid").jqGrid({
                ...
                colNames: ['순번','분야', '통제', '통제항목', '항목추가','점검항목', '수정', '설명'],
                colModel: [
                        ...
                        { name: 'rgldtlid', sortable : false, resizable:false, width:"10%", align: 'center', cellattr: arrtSetting, formatter:btnFormatter},
                        { name: 'inspectitem', width: "20%" },
                        { name: 'itemseq', width: "10%", align: 'center', formatter:btnFormatterEdit },
                        { name: 'inspectdetail', width: "20%" }
                ],
