...
rex_gsRexServiceRootURL = window.location.protocol + "//" + window.location.host + "/tems/";
...
rex_gsRptServiceURL = rex_gsRexServiceRootURL + "rex/rexservice.jsp";
