                        ...
                        <div class="form-horizontal form-terms ">
                            <div class="jarviswidget jarviswidget-sortable" role="widget">
                                <div class="widget-body">
                                    <fieldset>
                                        <div class="col-md-6 form-group" style="float: left; width: 400px">
                                            <label class="col-md-6 form-label"><b>조직도</b></label>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
                        ...
                        <div class="form-horizontal form-terms ">
                            <div class="jarviswidget jarviswidget-sortable" role="widget">
                                <div class="widget-body">
                                    <fieldset>
                                        <div class="col-md-6 form-group" style="float: left; width: 400px">
                                            <label class="col-md-6 form-label"><b>부서별 사용자</b></label>
                                        </div>
                                        <div style="float: right">
                                            <button class="btn btn-primary" id="save2">저장</button>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
