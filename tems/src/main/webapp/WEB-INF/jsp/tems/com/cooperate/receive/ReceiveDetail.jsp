...
<script>
	...
	function fnGoList(){
		window.location.href="<c:url value='/cooperate/receive/ReceiveList.do'/>";
	...
	function fnNext(){
		...
		document.frm.action = "<c:url value='/cooperate/receive/reqReceiveDetail.do'/>";
		document.frm.submit();
		}
    }
  ...
  <div class="modal-dialog apprDialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body apprBody">
      	<textarea class="form-control" rows="4" id="trejdesc" name="trejdesc" placeholder="반려사유를 적어주십시오."></textarea>
      </div>
