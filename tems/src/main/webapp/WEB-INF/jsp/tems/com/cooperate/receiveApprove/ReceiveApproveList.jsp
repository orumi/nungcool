...
<script>
	...
	function getCooperationList(){
		...
		$.ajax({
		    ...
		    dataType : "json",
		    data : data,
            url: "<c:url value='/cooperate/receiveApprove/getCoopApprList.json'/>",
            success: function (data) {
            	dataProvider.fillJsonData(data.cooperateApprList);
            },
    ...
    function fnConfirmAll(){
 		...
 		var data = {"data":val};
 		var url = "<c:url value='/cooperate/receiveApprove/upCoopAppr.json'/>";
 		saveData(url,data);	
 	 }
