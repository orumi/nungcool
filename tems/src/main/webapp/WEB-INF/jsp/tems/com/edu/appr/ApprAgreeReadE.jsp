...
$("#btn_agreeOK").on("click", function() { 
	...
	var url = "apprAgreeReadE.do?apprID="+apprID+"&crtPage="+crtPage+"&rowCnt="+rowCnt+"&searchType="+searchType+"&keyword="+keyword ;
...
$("#btn_reject").on("click", function() { 
	...
	$.ajax({
		...
		success: function(event){	
			location.href = "./apprAgreeReadE.do?&apprID="+apprID+"&crtPage"+${cri.crtPage }+"&rowCnt="+${cri.rowCnt };
		}
	});
