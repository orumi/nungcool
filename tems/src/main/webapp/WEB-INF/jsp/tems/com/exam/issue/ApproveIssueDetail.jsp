...
<script>
	...
	function fnGetReqResultList(){
		...
		$.ajax({
            ...
            url: "<c:url value='/exam/result/getResultList.json'/>",
            success: function (data) {
	...
	function fnGetRejectResultList(){
		...
		$.ajax({
		    ...
		    dataType : "json",
		    data : {"reqid":reqid},
            url: "<c:url value='/exam/issue/getRejectResultList.json'/>",
            success: function (data) {
	...
	function fnNext(){
		...
		document.frm.action = "<c:url value='/exam/issue/ApproveIssueDetail.do'/>";
		document.frm.submit();
		}
    }
