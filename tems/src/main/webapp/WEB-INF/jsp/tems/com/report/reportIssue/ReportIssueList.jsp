...
<script src="<c:url value='/js/tems/report/ReportIssueList.js'/>"></script>  
...
<script>
	...
	function getReportIssueList(){
		...
		$.ajax({
		    ...
		    dataType : "json",
		    data : data,
            url: "<c:url value='/report/reportIssue/getReportIssueList.json'/>",
	...
	var eSignURL= "<c:url value='/ajax/executeESign.json'/>";
    ...
    <div role="content">
		<div class="dt-toolbar">
			...
			<div class="col-sm-6 text-right" >
				...
				<button class="btn btn-default" onclick="javascript:fnIssueReport();">
					성적서나눔결재
				</button>
			</div>
...
<!--전자결재정보 -->
<input type="hidden" id="createEleSignUrl" name="createEleSignUrl" value="${createEleSignUrl}" />
<input type="hidden" id="openEleSignUrl" name="openEleSignUrl" value="${openEleSignUrl}" />
<input type="hidden" id="eleSignServer" name="eleSignServer" value="${eleSignServer}" />
<input type="hidden" id="eleSignLimsName" name="eleSignLimsName" value="${eleSignLimsName}" />
<input type="hidden" id="fileURL" name="fileURL" value="${file_url}" />

<form id="eDocFrm" name="eDocFrm" method="post">
