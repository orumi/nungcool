...
<script>
    ...
    function getCooperationList() {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: data,
            url: "<c:url value='/officialExam/cooperation/getCooperationList.json'/>",
    ...
    function fnConfirmAll() {
        ...
        var data = {"data": val};
        var url = "<c:url value='/officialExam/cooperation/upCooperApproval.json'/>";
        saveData(url, data);
    }
    ...
    function fnConfirm() {
        ...
        document.frm.action = "<c:url value='/officialExam/cooperation/CooperationDetail.do'/>";
        document.frm.submit();
    }
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="col-sm-2 form-button">
                                    <button class="btn btn-default btn-primary" type="button"
                                            onclick="javascript:getCooperationList();">
    ...
    <div role="content">
        <div class="dt-toolbar">
            ...
            <div class="col-sm-6 text-right">
                <!-- <button class="btn btn-default" onclick="location.href='/tems/officialExam/cooperation/CooperationDetail.do'">
                    상세보기
                </button> -->
