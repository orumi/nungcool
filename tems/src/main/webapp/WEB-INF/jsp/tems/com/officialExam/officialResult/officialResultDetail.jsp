...
<div class="page-content">
    ...
    <!-- 맨 아랫줄 -->
    <div role="content" style="width:38%; float:left">
        <div class="dt-toolbar">
            <div class="col-sm-5">
            ...
            <div class="col-sm-7 text-right">
                <form id="frm" name="frm" action="<c:url value='/common/fileattach.json'/>" method="post"
                    ...
                    <input type="file" id="attach" name="attach" style="width:200px; float:right"
                           onchange="javascript:fnAttachSubmit();"/>
                </form>
            </div>
        </div>
                                    ...
                                    <fieldset>
                                        <div class="col-md-12 form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="div-realgrid">
                                                    <h4 class="modal-title">선택된사용자</h4>
