...
<script>
    ...
    function fnSaveResult(){
	    ...
	    if(confirm("선택된 내용을 \n 저장 하시겠습니까?")){
	    	saveData("<c:url value='/cooperate/result/upCoopResultDetail.json'/>",data);	
	    }
    }
	...
	function fnSaveConf(){
	    ...
	    var data = {"data":val};
	    if(confirm("선택된 내용을 \n 저장 하시겠습니까?")){
	    	saveData("<c:url value='/cooperate/result/upCoopResultState.json'/>",data);	
	    }
	}
</script>	
		...
		<div class="dt-toolbar">
			...
			<div class="col-sm-7 text-right" >
				<button class="btn btn-primary" onclick="javascript:fnSaveResult();">
					<i class="fa fa-save"></i> 결과저장
				</button>
				<button class="btn btn-success" onclick="javascript:fnSaveConf();">
					<i class="glyphicon glyphicon-ok "></i> 결과등록 완료
				</button>
...
<jsp:include page="/include/approval/reqCooperApprovalPop.jsp"></jsp:include>