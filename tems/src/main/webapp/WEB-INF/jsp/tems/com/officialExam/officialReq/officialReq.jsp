...
<script>
    ...
    $(document).ready(function () {
        ...
        var columns = [
            ...
            },
            {
                ...
                dynamicStyles: [{criteria: "value like '%%'", styles: "background=#f78c40"}],
                width: 100,
                readOnly: "true"
            },
            {
        ...
        gridView.onLinkableCellClicked = function (grid, index, url) {
            if (index.column == "apprstatenm") {
                ...
                window.location.href = "<c:url value='/officialExam/req/ReqListDetail.do?reqid="+gridView.getValue(index.itemIndex,"reqid")+"'/>";
    ...
    function sel() {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: data,
            url: "<c:url value='/officialExam/req/selReqList.json'/>",
            success: function (data) {
    ...
    function fnPriceTypeSave() {
        ...
        if (confirm("변경된 내용을 저장하시겠습니까?")) {
            saveData("<c:url value='/officialExam/req/edtReqList.json'/>", data);
        }
    ...
    function fnReqStateChange() {
        ...
        if (confirm("선택된 내용을 저장하시겠습니까?")) {
            saveData("<c:url value='/officialExam/req/upReqState.json'/>", data);
        }
    }
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control selectBox" id="pricetype">
                                    ...
                                    <c:forEach var="ComboList17" items="${ComboList17}">
                                        <option value="<c:out value="${ComboList17.codeid}"/>"><c:out
                                                value="${ComboList17.codename}"/></option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9">
                                <select class="form-control selectBox" id="apprstate">
                                    ...
                                    <c:forEach var="ApprComboList" items="${ApprComboList}">
                                        <option value="<c:out value="${ApprComboList.codeid}"/>"><c:out
                                                value="${ApprComboList.codename}"/></option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
            ...
            <div class="modal-body requestBody">
                ...
                <div style="width: 50;height: 100%; display: table; float:left; margin:0 16px;">
                    <div style="display: table-cell;vertical-align: middle;">
                        ...
                        <p style="padding:6px;">
                            <a href="javascript:fnCancelAppr();" class="btn btn-default"><i
                ...
                <div style="width: 516px; float:left;">
                    <a href="javascript:fnAddRow();" class="btn btn-default pull-right"
                       style="margin-bottom: 2px; margin-left: 2px; ">신규</a>
    ...
    <div class="modal-dialog apprDialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body apprBody">
                ...
                <textarea class="form-control" placeholder="" rows="4" id="trejdesc" name="trejdesc"
