...
<script>
	...
	function getReceiveList(){
		...
		$.ajax({
		    ...
		    dataType : "json",
		    data : data,
            url: "<c:url value='/cooperate/receive/getReceiveList.json'/>",
            success: function (data) {
            	dataProvider.fillJsonData(data.cooperateReceiveList);
            },
    ...
    function fnConfirmAll(){
 		...
 		var data = {"data":val};
 		var url = "<c:url value='/cooperate/receive/upReceive.json'/>";
 		saveData(url,data);	
 	 }
