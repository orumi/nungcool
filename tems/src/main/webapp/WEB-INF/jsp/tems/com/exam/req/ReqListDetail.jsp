	...
	<div class="widget-body">
		...
		<div class="col-md-12 form-group ">
			...
			<div class="col-md-10 col-89p">
				...
				<input type="text" class="form-control inputBox" id="remark" name="remark" value="${reqDetail.remark}"/>
				<c:if test="${reqDetail.reqstate eq '0'}">
				<div class="input-group-btn">
					<button class="btn btn-primary" onclick="javascript:fnSaveRemark();" style="padding-top:4px; padding-bottom:4px; margin-top:1px;">
...
<!--  신청 항목 창  -->	
	...
	<div class="form-vertical widget-body">
		...
		<div class="col-11p form-group">
			...
			<div class="col-md-12">
				<input type="text" class="form-control inputBox" style="text-align: right;" id="sumetcprice"/>
			</div>
		</div>
		<div class="col-11p form-group">
		...
		<div class="col-11p form-group">
			...
			<div class="col-md-12">
				<input type="text" class="form-control inputBox" style="text-align: right;" id="sumaddprice"/>
			</div>
		</div>
		<div class="col-11p form-group">
...
<div class="col col-md-12 no-padding" style="margin-bottom:13px !important;">	
	...
	<div role="content" style="clear:both;">
		<div class="dt-toolbar border-bottom-solid">
			...
			<div class="col-sm-6 text-right" >
				<button class="btn btn-default" onclick="javascript:fnGoList();" style="float:right; margin-left:13px;">
					<i class="fa fa-th-list"></i> 목록
				</button>
