...
<%@ page import="tems.com.main.model.ReqTestRegVO" %>
<%@ page import="java.util.List" %>
<%@ page import="tems.com.main.model.ProgressStateVO" %>
<%@ page import="tems.com.main.model.ProgressInfoVO" %>
<%@ page import="tems.com.main.model.NoticeBoardVO" %>
<%
        ...
        <article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
            <div class="widget-body">
                <ul id="myTab1" class="nav nav-tabs bordered">
                    ...
                    <li><a href="#s3" data-toggle="tab" aria-expanded="true">&nbsp;&nbsp;&nbsp;교&nbsp;육&nbsp;&nbsp;&nbsp; </a>
                    </li>
                                        ...
                                        <div class="widget-body no-padding">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <c:forEach var="list" items="${reqTestRegList}">
                                                        <tr>
                                                            <td>${list.requestCdate}
                                                            </td>
                                                            <td class="cutStringL">${list.compName}
                                                            </td>
                                                            <td>${list.regName}
                                                            </td>

                                                            <c:if test="${list.reqState  eq '접수대기'}">
                                                                <td class="text-center"><span
                                                                        class="label label-default">${list.reqState}</span>
                                                                </td>
                                                            </c:if>

                                                            <c:if test="${list.reqState  eq '접수완료'}">
                                                                <td class="text-center"><span
                                                                        class="label label-primary">${list.reqState}</span>
                                                                </td>
                                                            </c:if>

                                                            <c:if test="${list.reqState  eq '분석승인'}">
                                                                <td class="text-center"><span
                                                                        class="label label-success">${list.reqState}</span>
                                                                </td>
                                                            </c:if>

                                                            <c:if test="${list.reqState  eq '시험완료'}">
                                                                <td class="text-center"><span
                                                                        class="label label-warning">${list.reqState}</span>
                                                                </td>
                                                            </c:if>

                                                            <c:if test="${list.reqState  eq '분석진행'}">
                                                                <td class="text-center"><span
                                                                        class="label label-info">${list.reqState}</span>
                                                                </td>
                                                            </c:if>

                                                            <c:if test="${list.reqState  eq '발급완료'}">
                                                                <td class="text-center"><span
                                                                        class="label label-danger">${list.reqState}</span>
                                                                </td>
                                                            </c:if>
                                                            ...
                                                            <td class="text-right">${list.sampleCNT}
                                                            </td>
                                                            <td class="text-right">${list.itemCNT}
                                                            </td>
                                                            <td class="text-center"><a href="javascript:void(0);"
                                                                                       class="btn bg-color-blueLight txt-color-white btn-xs"><i
                                                                    class="fa fa-krw"></i></a></td>
                                                        </tr>
                                                    </c:forEach>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="widget-body no-padding">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <c:forEach var="list" items="${progressInfoList}">
                                                        <tbody>
                                                        <tr>
                                                            <td rowspan="3">접수</td>
                                                            <td>일반(협조)</td>
                                                            <td class="text-right">${list.generalRegist}
                                                            </td>
                                                            <td class="text-right">(${list.generalCooperation})
                                                            </td>
                                                            <td class="text-right">${list.generalReject}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>등본</td>
                                                            <td class="text-right">${list.copyRegist}
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>통합</td>
                                                            <td class="text-right">${list.mergedRegist}
                                                            </td>
                                                            <td class="text-right"></td>
                                                            <td class="text-right">${list.mergedReject}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td rowspan="2">결과미등록</td>
                                                            <td>시료(협조)</td>
                                                            <td class="text-right">${list.resultUnregistedSample}
                                                            </td>
                                                            <td class="text-right">
                                                                (${list.resultUnregistedSampleCoo})
                                                            </td>
                                                            <td class="text-right"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>항목(협조)</td>
                                                            <td class="text-right">${list.resultUnregisteredItem}
                                                            </td>
                                                            <td class="text-right">
                                                                (${list.resultUnregisteredItemCoo})
                                                            </td>
                                                            <td class="text-right"></td>
                                                        </tr>
                                                        <tr>
                                                            <td rowspan="3">결재</td>
                                                            <td>접수(협조)</td>
                                                            <td class="text-right">${list.paymentRecieved}
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>발급</td>
                                                            <td class="text-right">${list.paymentIssued}
                                                            </td>
                                                            <td class="text-right"></td>
                                                            <td class="text-right"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>기타</td>
                                                            <td class="text-right">${list.etcPayment}
                                                            </td>
                                                            <td class="text-right"></td>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <c:forEach var="list" items="${progressList}">
                                                        <tr>
                                                            <td class="cutStringL">${list.reportNO}
                                                            </td>
                                                            <td class="cutStringL">${list.requestCDate}
                                                            </td>
                                                            <td class="cutStringL">${list.compName}
                                                            </td>
                                                            <td>${list.regName}
                                                            </td>
                                                            <td class="text-right">${list.smpCNT}
                                                            </td>
                                                            <td class="text-right">${list.itemCNT}
                                                            </td>
                                                            ...
                                                            <c:if test="${list.reqState  eq '작성중'}">
                                                                <td class="text-center"><span
                                                                        class="label label-success">${list.reqState}</span>
                                                                </td>
                                                            </c:if>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><span
                                                                class="label bg-color-pink">진행</span></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>16.07.05</td>
                                                        <td class="text-center"><span
                                                                class="label label-default">대기</span></td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>본사</td>
                                                        <td class="text-center"><span
                                                                class="label label-default">접수대기</span></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>강원</td>
                                                        <td class="text-center"><span
                                                                class="label label-primary">접수완료</span></td>
                                                        <td class="text-right">3</td>
                                                        <td class="text-right">3</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>연구소</td>
                                                        <td class="text-center"><span
                                                                class="label label-success">분석승인</span></td>
                                                        <td class="text-right">3</td>
                                                        <td class="text-right">3</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>영남</td>
                                                        <td class="text-center"><span
                                                                class="label label-info">분석진행</span></td>
                                                        <td class="text-right">3</td>
                                                        <td class="text-right">3</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>강원</td>
                                                        <td class="text-center"><span
                                                                class="label label-warning">시험완료</span></td>
                                                        <td class="text-right">3</td>
                                                        <td class="text-right">3</td>
                                                    </tr>
                                                    </tbody>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="cutStringL">(주)신승케미칼</td>
                                                        <td>15.09.18</td>
                                                        <td><span class="label label-success">16.09.17</span></td>
                                                        <td class="text-center"><span
                                                                class="label bg-color-pink">진행</span></td>
                                                    </tr>
                                                    <tr>
        ...
        <div class="well well-light col-sm-12 col-md-12 col-lg-12 padding-bottom-0">
            ...
            <table class="table table-striped">
                ...
                <%
                    ...
                    for (NoticeBoardVO vo : noticeList) {
                %>
                <tr>
                    <td>
                        <a href="${pageContext.request.contextPath}/enotice/read.do?bID=<%=vo.getBID()%>"><%=vo.getTitle()%>
                        </a></td>
                    <td><%=vo.getRegDate()%>
                    </td>
                </tr>
