...
<head>
    ...
    <script language="javascript1.2" type="text/javaScript">
        ...
        function choisProgramListSearch(fileName) {
            $("#progrmFileNm").val(fileName);
        }
        ...
        function insertMenuList() {
            if (document.menuManageVO.tmp_CheckVal.value == "U") {
        ...
        function updateMenuList() {
            if (document.menuManageVO.tmp_CheckVal.value != "U") {
                alert("상세조회시는 수정혹은 삭제만 가능합니다. 초기화 하신 후 등록하세요.");
                return;
            }
            ...
            <div class="jarviswidget jarviswidget-sortable" id="wid-id-0" data-widget-colorbutton="false"
                ...
                <div role="content">
                    <div class="widget-body" style="height:500px;">
                        ...
                        <div class="tree"
                             style="left:0px; top:10px; width:100%; height:100%; z-index:10; overflow:scroll">
                    ...
                    <div class="widget-body" style="height:500px;">
                        ...
                        <div class="form-top-actions">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <button id="btn_init" class="btn btn-labeled btn-default"
                                            onclick="initlMenuList(); return false;" type="button"><span
                                            class="btn-label"><i class="glyphicon glyphicon-refresh"></i></span>초기화
                                    </button>
                                    &nbsp;
                                    <button id="btn_save" class="btn btn-primary"
                                            onclick="insertMenuList(); return false;" type="button"><i
                                            class="fa fa-save"></i> <spring:message code="button.save"/></button>
                                    <button id="btn_save" class="btn btn-primary"
                                            onclick="updateMenuList(); return false;" type="button"><i
                                            class="fa fa-save"></i> <spring:message code="button.update"/></button>
                                    <button id="btn_save" class="btn btn-danger"
                                            onclick="deleteMenuList(); return false;" type="button"><i
                                            class="fa fa-remove"></i> <spring:message code="button.delete"/></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <label class="col-md-3 control-label">메뉴No<img
                                        src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />"
                                        width="15" height="15" alt="필수입력표시"></label>

                                <div class="col-md-9">
                                    <input class="form-control" name="menuNo" type="text" size="10" value=""
                                           maxlength="10" title="메뉴No">
                                </div>
                            </div>
                            <div class="form-group">

                                <label class="col-md-3 control-label">메뉴순서<img
                                        src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />"
                                        width="15" height="15" alt="필수입력표시"></label>

                                <div class="col-md-9">
                                    <input class="form-control" name="menuOrdr" type="text" size="10" value=""
                                           maxlength="10" title="메뉴순서">
                                </div>
                            </div>
                            <div class="form-group">

                                <label class="col-md-3 control-label">메뉴명<img
                                        src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />"
                                        width="15" height="15" alt="필수입력표시"></label>

                                <div class="col-md-9">
                                    <input class="form-control" name="menuNm" type="text" size="30" value=""
                                           maxlength="30" title="메뉴명">
                                </div>
                            </div>
                            <div class="form-group">

                                <label class="col-md-3 control-label">상위메뉴No<img
                                        src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />"
                                        width="15" height="15" alt="필수입력표시"></label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="upperMenuId" type="text" size="10"
                                                       value="" maxlength="10" title="상위메뉴No">

                                                <div class="input-group-btn">
                                                    <button class="btn btn-default"
                                                            onclick="mvmnMenuList();return false;" type="button">
                                                        메뉴검색
                                                    </button>
                                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-md-3 control-label">파일명<img
                                        src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />"
                                        width="15" height="15" alt="필수입력표시"></label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="progrmFileNm" name="progrmFileNm" type="text" size="30"
                                                       value="" maxlength="60" title="파일명">

                                                <div class="input-group-btn">
                                                    <button class="btn btn-default"
                                                            onclick="searchFileNm();return false;" type="button">
                                                        파일명 검색
                                                    </button>
                                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" name="relateImageNm" type="text" size="30" value=""
                                           maxlength="30" title="관련이미지명">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" name="relateImagePath" type="text" size="30" value=""
                                           maxlength="60" title="관련이미지경로">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" name="menuDc" class="textarea" cols="45" rows="8"
                                              title="메뉴설명"></textarea>
                                </div>
                            </div>
                        </fieldset>
