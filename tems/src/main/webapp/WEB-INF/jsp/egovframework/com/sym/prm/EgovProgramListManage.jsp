        ...
        <table border="0">
            <tr>
                <td width="700">
                    ...
                    <form name="progrmManageForm" action="<c:url value='/sym/prm/EgovProgramListManageSelect.do' />"
                          method="post">
                        ...
                        <DIV id="main" style="display:">
                                ...
                                <tr>
                                    <td width="40%" class="title_left">
                                        <h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />"
                                                 width="16" height="16" hspace="3" alt="">&nbsp;프로그램목록관리</h1></td>
                                </tr>
                            </table>
                            <table width="791" border="0" cellpadding="0" cellspacing="1">
                                <tr>
                                    <td width="100%">
                                        <table width="100%" border="0" cellspacing="1" class="table-register"
                                               summary="프로그램목록관리 검색조건">
                                            <caption>프로그램목록관리</caption>
                                            <tr>
                                                <th width="20%" height="40" class="" scope="row"><label
                                                        for="searchKeyword">프로그램명</label><img
                                                        src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />"
                                                        width="15" height="15" alt="필수입력표시"></th>
                                                <td width="80%">
                                                    <table border="0" cellspacing="0" cellpadding="0" align="left">
                                                        <tr>
                                                            <td>&nbsp;<input name="searchKeyword" type="text" size="60"
                                                                             value="${searchVO.searchKeyword}"
                                                                             maxlength="60" id="F1" title="검색조건"></td>
                                                            <td width="5%"></td>
                                                            <td><span class="button"><input type="submit"
                                                                                            value="<spring:message code="button.inquire" />"
                                                                                            onclick="selectProgramListManage(); return false;"></span>
                                                            </td>
                                                            <td width="5%"></td>
                                                            <td width="20%"><span class="button"><a
                                                                    href="<c:url value='/sym/prm/EgovProgramListRegist.do'/>"
                                                                    onclick="insertProgramListManage(); return false;"><spring:message
                                                                    code="button.create"/></a></span></td>
                                                            <td width="5%"></td>
                                                            <td width="20%"><span class="button"><a href="#LINK"
                                                                                                    onclick="fDeleteProgrmManageList(); return false;"><spring:message
                            ...
                            <table width="717" cellpadding="8" class="table-line" style="table-layout:fixed"
                                ...
                                <tbody>
                                &lt;%&ndash; 데이터를 없을때 화면에 메세지를 출력해준다 &ndash;%&gt;
                                ...
                                <c:forEach var="result" items="${list_progrmmanage}" varStatus="status">
                                    <tr>
                                        <td class="lt_text3" nowrap>
                                            ...
                                            <input name="checkProgrmFileNm" type="hidden"
                                                   value="<c:out value='${result.progrmFileNm}'/>"/>
                                        </td>
                        ...
                        <div class="dt-toolbar" style="border-bottom: 1px solid #CCC !important">
                            <div class="col-xs-12 col-sm-6">
                                <div id="dt_basic_filter" class="dataTables_filter"><label><span
                                        class="input-group-addon" style="width: 150px; text-align: right">프로그램 명<i
                            ...
                            <div class="col-sm-6 col-xs-12 hidden-xs">
                                <div class="dataTables_length" id="dt_basic_length">
                                    ...
                                    <input type="submit" value="등록" class="btn btn-default btn-default"
                                           onclick="insertProgramListManage(); return false;"/>
                                    <input type="submit" value="삭제" class="btn btn-default btn-default"
                                           onclick="fDeleteProgrmManageList(); return false;"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover dataTable no-footer"
                            ...
                            <tr role="row">
                                ...
                                <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                    rowspan="1"
                                    colspan="1"
                                    style=" text-align: center; background-color: #EEEEEE">프로그램 파일 명
                                </th>
                                <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                    rowspan="1"
                                    colspan="1"
                                    style=" text-align: center; background-color: #EEEEEE">프로그램 명
                                </th>
                                <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                    rowspan="1"
                                    colspan="1"
                                    style=" text-align: center; background-color: #EEEEEE">URL
                                </th>
                                <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                    rowspan="1"
                                    colspan="1"
                                    style=" text-align: center; background-color: #EEEEEE">프로그램 상세
                                </th>
                            </tr>
                            </thead>
                            ...
                            <c:forEach var="result" items="${list_progrmmanage}" varStatus="status">
                                <tr>
                                    ...
                                    <td class="lt_text" style="cursor:hand;" nowrap><span class="link"><a
                                            href="<c:url value='/sym/prm/EgovProgramListDetailSelect.do'/>?tmp_progrmNm=<c:out value="${result.progrmFileNm}"/>"
                                            onclick="selectUpdtProgramListDetail('<c:out
                                                    value="${result.progrmFileNm}"/>'); return false;">
