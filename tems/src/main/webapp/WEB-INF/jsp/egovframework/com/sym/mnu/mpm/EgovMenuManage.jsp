    ...
    <div id="border" style="width:730px">
        <table border="0">
            <tr>
                <td width="700">
                    <!-- ********** 여기서 부터 본문 내용 *************** -->
                    <form name="menuManageForm" action="<c:url value='/sym/mnu/mpm/EgovMenuManageSelect.do'/>"
                          method="post">
                            ...
                            <tr>
                                <td width="40%" class="title_left">
                                    <h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />"
                                             width="16" height="16" hspace="3" alt=""/>&nbsp;메뉴관리리스트</h1></td>
                                <td width="10%"></td>
                                <td width="35%"></td>
                                <td width="10%"></td>
                            </tr>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" summary="메뉴관리 처리버튼">
                                        ...
                                        <tr>
                                            <td><span class="button"><a
                                                    href="<c:url value='/sym/mnu/mpm/EgovMenuRegistInsert.do'/>"
                                                    onclick="bndeInsertMenuManage(); return false;">일괄등록</a></span></td>
                                            <td width="5%"></td>
                                            <td><span class="button"><a
                                                    href="javascript:insertMenuManage();"
                                                    ><spring:message
                                                    code="button.create"/></a></span></td>
                                            <td width="5%"></td>
                                            <td><span class="button"><a href="#LINK"
                                                                        onclick="fDeleteMenuList(); return false;"><spring:message
                        ...
                        <table width="717" cellpadding="8" class="table-line" style="table-layout:fixed"
                               summary="메뉴관리 목록 조회화면으로 메뉴ID,메뉴한글명,프로그램파일명,메뉴설명,상위메뉴ID로 구성.">
                            <caption>메뉴관리 목록 조회</caption>
                            <thead>
                            <tr>
                                <th class="title" width="30">
                                    <input type="checkbox" name="checkAll" class="check2"
                                           onclick="javascript:fCheckAll();" title="전체선택"/>
                                </th>
                            ...
                            <c:forEach var="result" items="${list_menumanage}" varStatus="status">
                                <tr>
                                    <td class="lt_text">
                                        ...
                                        <input name="checkMenuNo" type="hidden"
                                               value="<c:out value='${result.menuNo}'/>"/>
                                    </td>
                                    <td class="lt_text"><c:out value="${result.menuNo}"/></td>
                                    <td class="lt_text" style="cursor:hand;">
                                        <span class="link"><a
                                                href="<c:url value='/sym/mnu/mpm/EgovMenuManageListDetailSelect.do?req_menuNo='/>${result.menuNo}"
                                                onclick="selectUpdtMenuManageDetail('<c:out
                                                        value="${result.menuNo}"/>'); return false;"><c:out
                                                value="${result.menuNm}"/></a></span>
                                    </td>
...
<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
    ...
    <form:form name="menuManageForm" commandName="" >
        <input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>"/>
        <input name="checkedMenuNoForDel" type="hidden"/>
                        ...
                        <div class="dt-toolbar" style="border-bottom: 1px solid #CCC !important">
                            ...
                            <div class="col-sm-6 col-xs-12 hidden-xs">
                                <div class="dataTables_length" id="dt_basic_length">
                                    <input type="submit" value="일괄등록" class="btn btn-default btn-default"
                                           onclick="bndeInsertMenuManage(); return false;"/>
                                    <input type="submit" value="등록" class="btn btn-default btn-default"
                                           onclick="insertMenuManage(); return false;"/>
                                    <input type="submit" value="삭제" class="btn btn-default btn-default"
                                           onclick="fDeleteMenuList(); return false;"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover dataTable no-footer"
                            ...
                            <tr role="row">
                                ...
                                <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                    rowspan="1"
                                    colspan="1"
                                    style=" text-align: center; background-color: #EEEEEE">메뉴ID
                                </th>
                                <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                    rowspan="1"
                                    colspan="1"
                                    style=" text-align: center; background-color: #EEEEEE">메뉴한글명
                                </th>
                                <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                    rowspan="1"
                                    colspan="1"
                                    style=" text-align: center; background-color: #EEEEEE">프로그램 파일명
                                </th>
                                <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                    rowspan="1"
                                    colspan="1"
                                    style=" text-align: center; background-color: #EEEEEE">메뉴설명
                                </th>
                                <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                    rowspan="1"
                                    colspan="1"
                                    style=" text-align: center; background-color: #EEEEEE">상위메뉴ID
                                </th>
                            </tr>
                            </thead>
                            ...
                            <c:forEach var="result" items="${list_menumanage}" varStatus="status">
                                <tr>
                                    <td class="lt_text" style="text-align: center">
                                        <input type="checkbox" name="checkField" class="check2" title="선택"/>
                                        <input name="checkMenuNo" type="hidden"
                                               value="<c:out value='${result.menuNo}'/>"/>
                                    </td>
