...
<div id="border" style="width:730px">
    <table border="0">
        <tr>
            <td width="700">
                <!-- ********** 여기서 부터 본문 내용 *************** -->
                <form name="menuManageRegistForm" action="<c:url value='/sym/mnu/mpm/EgovMenuBndeRegist.do'/>"
                        ...
                        <tr>
                            <td width="40%" class="title_left">
                                <h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />"
                                         width="16" height="16" hspace="3" alt=""/>&nbsp;메뉴일괄등록</h1></td>
                            <td width="10%"></td>
                            <td width="35%"></td>
                        </tr>
                    </table>
           ...
           <td><img src="<%=imagePath_button %>bu2_right.gif' />" width="8" height="20"></td-->
                                        <td width="10"></td>
                                        <td><span class="button"><input type="submit" value="일괄등록"
                                                                        onclick="insertMenuManage(); return false;"/></span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td width="100%">
                                <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
                                    <tr>
                                        <th width="20%" height="40" class="required_text">일괄파일<img
                                                src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />"
                                                width="15" height="15" alt="필수입력표시"/>&nbsp;</th>
                                        <td width="80%">
                                            <table border="0" cellspacing="0" cellpadding="0" align="left">
                                                <tr>
                                                    <td>&nbsp;<input type="file" name="file" size="40" title="일괄파일"/>
                                                    </td>
                                                    <td width="5%"></td>
                                                </tr>
                                            </table>
                        ...
                        <div class="dt-toolbar" style="border-bottom: 1px solid #CCC !important">
                            <div class="col-xs-12 col-sm-6">
                                <div id="dt_basic_filter" class="dataTables_filter"><label><span
                                    ...
                                    <input type="file" name="file" size="40" title="일괄파일" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-12 hidden-xs">
                                ...
                                <span class="button"><input type="submit" value="일괄등록"
                                                            onclick="insertMenuManage(); return false;"/></span>
                                </div>
                            </div>
                        </div>
