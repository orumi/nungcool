        ...
        <table border="0">
            <tr>
                <td width="700">
                    ...
                    <form:form name="listForm" action="${pageContext.request.contextPath}/sec/ram/EgovAuthorList.do"
                               method="post">
                        <table width="100%" cellpadding="8" class="table-search" border="0">
                            <tr>
                                <td width="20%" class="title_left">
                                    <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />"
                                         width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;권한 관리
                                </td>

                                <td width="60%">권한 명 : <input name="searchKeyword" type="text"
                                                              value="<c:out value='${authorManageVO.searchKeyword}'/>"
                                                              size="25" title="검색" onkeypress="press();"/></td>
                                <th width="20%">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td class="btnBackground" nowrap="nowrap"><a href="#LINK"
                                                                                         onclick="javascript:fncSelectAuthorList('1')"
                                                                                         style="selector-dummy:expression(this.hideFocus=false);">조회</a>
                                            </td>
                                            <td><img
                                            ...
                                            <td class="btnBackground" nowrap="nowrap"><a
                                                    href="javascript:fncAddAuthorInsert();"
                                            ...
                                            <td><img
                                                    ...
                                                    width="8" height="20" alt="버튼이미지"></td>
                                            <td class="btnBackground" nowrap="nowrap"><a href="#LINK"
                                                                                         onclick="javascript:fncAuthorDeleteList()"
                        ...
                        <table width="100%" cellpadding="8" class="table-line"
                               summary="권한관리에  관한 테이블입니다.권한ID,권한 명,설명, 등록일자, 롤 정보의 내용을 담고 있습니다.">
                            <thead>
                            <tr>
                                <th class="title" width="3%" nowrap="nowrap"><input type="checkbox" name="checkAll"
                                                                                    class="check2"
                            ...
                            <c:forEach var="author" items="${authorList}" varStatus="status">
                                <tr>
                                    <td class="lt_text3" nowrap="nowrap"><input type="checkbox" name="delYn"
                                                                                class="check2" title="선택"><input
                                            type="hidden" name="checkId" value="<c:out value="${author.authorCode}"/>"/>
                                    </td>
                                    <td class="lt_text" nowrap="nowrap"><a href="#LINK"
                                                                           onclick="javascript:fncSelectAuthor('<c:out
                                                                                   value="${author.authorCode}"/>')"><c:out
                ...
                <div id="dt_basic_wrapper" class="dataTables_wrapper form-inline no-footer">
                    ...
                    <div class="dt-toolbar" style="border-bottom: 1px solid #CCC !important">
                        <div class="col-xs-12 col-sm-6">
                            <div id="dt_basic_filter" class="dataTables_filter"><label>
                                <span class="input-group-addon" style="width: 150px; text-align: right; float: left">
                                    권한 명
                        ...
                        <div class="col-sm-6 col-xs-12 hidden-xs">
                            <div class="dataTables_length" id="dt_basic_length">
                                <input type="submit" value="조회" class="btn btn-default btn-default"
                                       onclick="fncSelectAuthorList(1); return false;"/>
                                <input type="submit" value="등록" class="btn btn-default btn-default"
                                       onclick="fncAddAuthorInsert(); return false;"/>
                                <input type="submit" value="삭제" class="btn btn-default btn-default"
                                       onclick="fncAuthorDeleteList(); return false;"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="dt_basic" class="table table-striped table-bordered table-hover dataTable no-footer"
                        ...
                        <tr role="row">
                            <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                rowspan="1"
                                colspan="1"
                                style="text-align: center; background-color: #EEEEEE">선택
                            </th>
                            <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                rowspan="1"
                                colspan="1"
                                style="text-align: center; background-color: #EEEEEE">권한ID
                            </th>
                            <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                rowspan="1"
                                colspan="1"
                                style="text-align: center; background-color: #EEEEEE">권한 명
                            </th>
                            <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                rowspan="1"
                                colspan="1"
                                style="text-align: center; background-color: #EEEEEE">설명
                            </th>
                            <th data-hide="phone" tabindex="0" aria-controls="dt_basic"
                                rowspan="1"
                                colspan="1"
                                style="text-align: center; background-color: #EEEEEE">등록일자
                            </th>
                        </tr>
                        </thead>
