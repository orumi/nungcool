...
<head>
    ...
    <script language="javascript1.2" type="text/javaScript"
            src="<c:url value='/js/egovframework/com/sym/mnu/mpm/EgovMenuList.js' />"></script>
    ...
    <script language="javascript1.2" type="text/javaScript">
        ...
        function updateMenuManage(form) {
            ...
            if (confirm("<spring:message code="common.save.msg"/>")) {
                ...
                /*document.getElementsByName("menuManageVO")[0].value = pageNo;*/
                document.getElementsByName("menuManageVO")[0].action = "<c:url value='/sym/mnu/mpm/EgovMenuListUpdt.do'/>";
                document.getElementsByName("menuManageVO")[0].submit();
            }
        }
        ...
        function deleteMenuManage(form) {
            if (confirm("<spring:message code="common.delete.msg"/>")) {
                document.forms[0].action = "<c:url value='/sym/mnu/mpm/EgovMenuManageDelete.do' />";
        ...
        function searchFileNm() {
            ...
            /*document.all.tmp_SearchElementName.value = "progrmFileNm";
             window.open("
            <c:url value='/sym/prm/EgovProgramListSearch.do' />", '', 'width=500,height=600');
             */
        ...
        function linkPage(pageNo) {
            document.getElementsByName("menuManageVO")[0].value = pageNo;
            document.getElementsByName("menuManageVO")[0].action = "<c:url value='/sym/prm/EgovProgramListSearch.do'/>";
            document.getElementsByName("menuManageVO")[0].submit();
        }
        ...
        <tr>
            <td width="700">
                ...
                <form:form commandName="menuManageVO" name="menuManageVO"
                           action="<c:url value='/sym/mnu/mpm/EgovMenuDetailSelectUpdt.do' />" method="post">

                    <table width="717" cellpadding="8" class="table-search" border="0">
                        <tr>
                            <td width="100%" class="title_left">
                                <h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />"
                                         width="16" height="16" hspace="3" alt=""/>&nbsp;메뉴상세조회및 수정</h1></td>
                        </tr>
                    </table>
                    <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register"
                        ...
                        <tr>
                            ...
                            <td width="85%" colspan="3">
                                ...
                                <a href="<c:url value='/sym/prm/EgovProgramListSearch.do' />" target="_blank"
                                   title="새창으로 이동" onclick="searchFileNm();return false;"
                                   style="selector-dummy:expression(this.hideFocus=false);"><img
                                        src="<c:url value='/images/egovframework/com/cmm/icon/search2.gif' />"
                        ...
                        <tr>
                            <th width="15%" height="23" class="required_text" scope="row"><label for="relateImageNm">관련이미지명</label><img
                                    src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15"
                                    height="15" alt="필수입력표시"/></th>
                            <td width="35%">&nbsp;
                            ...
                            <th width="15%" height="23" class="required_text" scope="row"><label for="relateImagePath">관련이미지경로</label><img
                                    src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15"
                                    height="15" alt="필수입력표시"/></th>
                            <td width="35%">&nbsp;
                                ...
                                <table width="717" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td><span class="button"><a
                                                href="<c:url value='/sym/mnu/mpm/EgovMenuManageSelect.do'/>"
                                                onclick="selectList(); return false;">목록</a></span></td>
                                        <td width="2%"></td>
                                        <td><span class="button"><input class="form-control"  type="submit"
                                                                        value="<spring:message code="button.update" />"
                                                                        onclick="updateMenuManage(document.forms[0]); return false;"/></span>
                                        </td>
                                        <td width="2%"></td>
                                        <td><span class="button"><a
                                                href="<c:url value='/uss/ion/evt/selectEventRceptList.do'/>?menuNo=<c:out value='${menuManageVO.menuNo}'/>"
                                                onclick="deleteMenuManage(document.forms[0]); return false;"><spring:message
                    ...
                    <br/>
                    <input class="form-control"  type="hidden" name="tmp_SearchElementName" value=""/>
                    <input class="form-control"  type="hidden" name="tmp_SearchElementVal" value=""/>
                    <input class="form-control"  name="cmd" type="hidden" value="update"/>
                </form:form>
                <!-- ********** 여기까지 내용 *************** -->
            </td>
        </tr>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div id="dt_basic_filter" class="dataTables_filter"><label><span
                                    ...
                                    <input class="form-control" name="searchKeyword"
                                           ...
                                           style="width: 400px">
                                    <input class="form-control" type="submit" value="조회"
                                           class="btn btn-default btn-default"
                                           style="width:60px;"
                                           onclick="selectProgramListManage(); return false;"/>
                                </label>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-12 hidden-xs">
                                <div class="dataTables_length" id="dt_basic_length">
                                    <button class="btn btn-default btn-default"
                                            onclick="javascript:selectList();">목록
                                    </button>
                                    <input class="form-control" type="submit" value="수정"
                                           class="btn btn-default btn-default"
                                           onclick="updateMenuManage(); return false;"/>
                                    <input class="form-control" type="submit" value="삭제"
                                           class="btn btn-default btn-default"
                                           onclick="deleteMenuManage(); return false;"/>
                                </div>
                            </div>
                        </div>
                        <form:form name="menuManageVO" commandName="menuManageVO"
                                   action="/sym/mnu/mpm/EgovMenuDetailSelectUpdt.do" method="post">
                            <table id="dt_basic"
                                ...
                                <tr>
                                    <th style="background-color: #EEEEEE" width="15%" height="23" class="required_text"
                                        scope="row" style="background-color: #EEEEEE"><label
                                            for="menuNo">메뉴No</label><img
                                    ...
                                    <th style="background-color: #EEEEEE" width="15%" height="23" class="required_text"
                                        scope="row"><label
                                            ...
                                            src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />"
                                            width="15"
                                            height="15" alt="필수입력표시" style="background-color: #EEEEEE"/></th>
                                    <td width="35%">
                                        &nbsp;
                                        <form:input path="menuOrdr" size="10" maxlength="10" title="메뉴순서"/>
                                        <form:errors path="menuOrdr"/>
                                ...
                                <tr>
                                    ...
                                    <td width="35%">&nbsp;
                                        ...
                                        <a href="<c:url value='/sym/mnu/mpm/EgovMenuListSelectMvmn.do' />"
                                           ...
                                           style="selector-dummy:expression(this.hideFocus=false);"><img
                                                src="<c:url value='/images/egovframework/com/cmm/icon/search2.gif' />"
                                                alt='' width="15" height="15"/>(메뉴선택 검색)
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th style="background-color: #EEEEEE" width="15%" height="23" class="required_text"
                                        scope="row"><label
                                            for="relateImageNm">관련이미지명</label><img
                                            src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />"
                                            width="15"
                                            height="15" alt="필수입력표시" style="background-color: #EEEEEE"/></th>
                                    <td width="35%">&nbsp;
                                    ...
                                    <th style="background-color: #EEEEEE" width="15%" height="23" class="required_text"
                                        scope="row"><label
                                            for="relateImagePath" style="background-color: #EEEEEE">관련이미지경로</label><img
                                            src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />"
                                            width="15"
                                            height="15" alt="필수입력표시"/></th>
                                    <td width="35%">&nbsp;
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">메뉴 선택</h4>
            </div>
...
<div class="modal fade" id="programFileName" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">프로그램 파일명 검색</h4>
            </div>
            <div class="modal-body requestBody" style="padding-right: 200px;">
                <div class="page-content">
                    <div role="content">
