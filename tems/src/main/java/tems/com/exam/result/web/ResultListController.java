...
public class ResultListController {
	...
	@RequestMapping(value="/exam/result/ResultList.do")
    public String ResultList(
		...
		List<ComboVO> StateComboList = ComboService.getStateCodeList("'6','7'");	//진행상태		0    접수대기,2    접수완료,4    분석진행,6    시험완료,7    결재완료,8    발급완료, 9 취소
 		...
 		model.addAttribute("StateComboList", StateComboList);
      	...
      	return "tems/com/exam/result/ResultList";
    }
	
    @RequestMapping(value="/exam/result/getRequestList.json")
    ...
    @RequestMapping(value="/exam/result/inApprConf.json")
