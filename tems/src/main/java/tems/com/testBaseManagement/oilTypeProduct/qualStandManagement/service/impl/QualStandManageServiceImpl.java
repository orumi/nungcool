...
public class QualStandManageServiceImpl implements QualStandManageService {
    ...
    @Override
    public List firstSelectList() throws Exception {
        return QualStandManageDAO.firstSelectList();
    }

    @Override
    public List secondSelectList() throws Exception {
        return QualStandManageDAO.secondSelectList();
    }

    @Override
    public List thirdSelectList() throws Exception {
        return QualStandManageDAO.thirdSelectList();
    }
