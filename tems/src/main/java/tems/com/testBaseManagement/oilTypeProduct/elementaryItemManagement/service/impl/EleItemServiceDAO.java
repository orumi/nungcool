...
public class EleItemServiceDAO extends EgovComAbstractDAO {
    ...
    public List<?> childsCheck(ElePopUpVO vo) throws Exception {
        return list("eleItemServiceDAO.childsCheck", vo);
    }
    ...
    public List<?> modalSearch(String str) throws Exception {
        return list("eleItemServiceDAO.modalSearch", str);
    }

    public List<?> identDupl(ElePopUpVO vo) throws Exception {
        return list("eleItemServiceDAO.duplItemIDInTCEMASTER", vo);
    }

    public void mergeIntoForParentsCheck(ElePopUpVO vo) throws Exception {
        update("eleItemServiceDAO.mergeIntoForParentsCheck", vo);
    }
