...
<body>
        <table width="717" cellpadding="8" class="table-search" border="0" summary="타이틀 기능을 제공한다.">
            <tr>
              <td width="100%" class="title_left"><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="" />&nbsp;사용자관리</td>
            </tr>
        </table>
        <!-- content start -->
            ...
            <tr>
                ...
                <td>
                    <table border="0" cellspacing="0" cellpadding="0" summary="">
                      <tr>
                        <td><span class="button"><a href="#" value="" onclick="fnSearch(); return false;"><spring:message code="button.search" /></a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        ...
        <br/>
        <table width="717" cellspacing="0" cellpadding="0" class="table-line" summary="사용자 목록을 제공한다.">
            <thead>
                <tr>
