...
<script type="text/javascript">
	...
	function fn_egov_select_noticeList(pageNo) {
		...
		document.frm.action = "<c:url value='/cop/bbs${prefix}/selectBoardLatestList.do'/>";
		document.frm.submit();
	}
...
<div id="border">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="ffffff" class="generalTable">
	  <tr>
