															...
															<div class="form-group"> 
																...
																<div class="col-md-4" style="padding-right: 1px;;">
													                <div class="icon-addon addon-md" >
													                    <input type="text" class="form-control"  ng-model="selVersion.pivernm"/>
													                </div>
													            </div>    
																<label class="control-label col-md-1" for="prepend" style="">정렬순서</label>
																<div class="col-md-4" style="padding-right: 1px;;">
													                <div class="icon-addon addon-md" >
													                    <input type="text" class="form-control"  ng-model="selVersion.sortby"/>
													                </div>
													            </div>    
															</div>
														</fieldset>
														...
														<fieldset>
																...
																<div class="table-responsive" style="height:200px;overflow-y: scroll;overflow-x:hidden; margin-bottom: 20px; ">		
																	<table class="table table-bordered">	
																		<tbody>
																			<tr ng-repeat="ver in version" style="cursor: pointer;" >
																				<td ng-click="actionShowVersion(ver)" style="width:40%">{{ver.pivernm}}</td>
