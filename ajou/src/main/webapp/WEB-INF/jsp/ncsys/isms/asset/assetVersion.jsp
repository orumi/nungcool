												...
												<div class="widget-body">
														<fieldset>
															<div class="form-group"> 
																<label class="control-label col-md-2" for="prepend" style="">자산버전</label>
																<div class="col-md-4" style="padding-right: 1px;;">
													                <div class="icon-addon addon-md" >
													                    <input type="text" class="form-control"  ng-model="entity.selAstVer.astvernm"/>
													                </div>
													            </div>    
																<label class="control-label col-md-2" for="prepend" style="">정렬순서</label>
																<div class="col-md-3" style="padding-right: 1px;;">
													                <div class="icon-addon addon-md" >
													                    <input type="text" class="form-control"  ng-model="entity.selAstVer.sortby"/>
													                </div>
													            </div>    
															</div>
														</fieldset>
														...
														<fieldset>
																...
																<div class="table-responsive" style="height:200px;overflow-y: scroll;overflow-x:hidden; margin-bottom: 20px; ">		
																	<table class="table table-bordered">	
																		<tbody>
																			<tr ng-repeat="ver in entity.selAstVers" style="cursor: pointer;" >
																				<td ng-click="actionShowVersion(ver)" style="width:40%">{{ver.astvernm}}</td>
