...
public class CertiDetail implements RglDetail{
	...
	public String getOwnertypenm() {
		return ownertypenm;
	}
	public void setOwnertypenm(String ownertypenm) {
		this.ownertypenm = ownertypenm;
	}
