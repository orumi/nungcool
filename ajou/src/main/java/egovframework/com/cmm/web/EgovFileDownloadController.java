...
public class EgovFileDownloadController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/cmm/fms/AttachFileDown.do")
	public void attachFileDownload(@RequestParam Map<String, Object> commandMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (isAuthenticated) {
			...
			fileVO.setAtchFileId(atchFileId);
			fileVO.setFileSn(fileSn);
			FileVO fvo = fileService.selectActualFileInf(fileVO);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/cmm/fms/gridExcelDown.do")
